...
To the best of the authors' knowledge, no prior work addresses C compilation for intentionally
...
Chapter~\ref{cap:related-work} surveys related work.
Chapter~\ref{cap:background} presents the conceptual background, covering the GCC compilation
framework, the RISC-V instruction set architecture, and the architecture of the Hennessy-Patterson
educational processor.
Chapter~\ref{cap:method} describes the development method, including the specification,
implementation, and testing phases followed for each target.
...
Chapter~\ref{cap:development} details the implementation, describing the instruction synthesis
techniques developed inside the GCC machine description and the per-target configuration files.
Chapter~\ref{cap:results} presents the test results and discusses the validity and limitations of
each target.
