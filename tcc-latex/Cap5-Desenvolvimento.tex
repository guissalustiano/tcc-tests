...
GNU Binutils supplies the assembler and linker. Its source is used without modification: every
restriction imposed by this work is enforced in the compiler, so the assembler must accept the full
base ISA and needs no changes at all. What does change is the configuration. GCC's \texttt{configure}
