...
{ "aarch64-*-elf", NULL },{ "aarch64-*-linux*", NULL },{ "aarch64-*-netbsd*", NULL },{ "aarch64-*-gnu*", NULL },{ "aarch64-*-nto*", NULL },{ "aarch64-*-rtems*", NULL },{ "aarch64-*-genode*",
...
{ "aarch64_be-*-elf", NULL },{ "aarch64_be-*-linux*", NULL },{ "aarch64_be-*-netbsd*",
...
{ "aarch64-*-freebsd*", NULL },{ "aarch64-*-openbsd*", NULL },{ "aarch64-*-fuchsia*", NULL },{ "aarch64-*-phoenix*",
&aarch64_elf64_le_vec },
#endif
...
#if !defined (SELECT_VECS) || defined (HAVE_iamcu_elf32_vec)
...
{ "i[3-7]86-*-elf*", NULL },{ "i[3-7]86-*-genode*", NULL },{ "i[3-7]86-*-nto*", NULL },{ "i[3-7]86-*-rtems*", NULL },{ "i[3-7]86-*-rdos*",
&i386_elf32_vec },
#endif
...
{ "i[3-7]86-*-dicos*", NULL },{ "i[3-7]86-*-dragonfly*", NULL },{ "i[3-7]86-*-netbsd*", NULL },{ "i[3-7]86-*-knetbsd*-gnu", NULL },{ "i[3-7]86-*-redox*",
&i386_elf32_vec },
#endif
...
{ "i[3-7]86-*-aros*", NULL },{ "i[3-7]86-*-gnu*", NULL },{ "i[3-7]86-*-openbsd*", NULL },{ "i[3-6]86-*-phoenix*",
&i386_elf32_vec },
#endif
...
{ "rvsc0-*-*", NULL },{ "rvsc1-*-*", NULL },{ "rvsc2-*-*", NULL },{ "rvsc3-*-*",
&riscv_elf32_vec },
#endif
...
{ "rvsc4-*-*", NULL },{ "rvsc5-*-*", NULL },{ "rvsc6-*-*", NULL },{ "rvsc7-*-*",
&riscv_elf64_vec },
#endif
...
{ "x86_64-*-dicos*", NULL },{ "x86_64-*-dragonfly*", NULL },{ "x86_64-*-haiku*", NULL },{ "x86_64-*-redox*",
&x86_64_elf64_vec },
#endif
...
{ "x86_64-*-elf*", NULL },{ "x86_64-*-fuchsia", NULL },{ "x86_64-*-genode*", NULL },{ "x86_64-*-gnu*",
&x86_64_elf64_vec },
#endif
