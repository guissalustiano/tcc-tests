  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      gt_ggc_m_9sat_entry ((*x).inst_entry);
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9sat_entry))
    {
      ...
      gt_pch_n_9sat_entry ((*x).inst_entry);
    }
}
...
{
  gt_cleare_cache (failed_completions_map);
