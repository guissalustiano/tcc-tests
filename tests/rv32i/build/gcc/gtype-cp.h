...
extern const struct ggc_root_tab gt_ggc_r_gt_cp_reflect_h[];
...
extern void gt_clear_caches_gt_cp_reflect_h ();
...
gt_clear_caches ()
{
  ...
  gt_clear_caches_gt_cp_reflect_h ();
...
extern const struct ggc_root_tab gt_pch_rs_gt_cp_reflect_h[];
