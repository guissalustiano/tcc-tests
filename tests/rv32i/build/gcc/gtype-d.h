        ...
        case TS_D_GENERIC:
          switch ((int) (tree_node_structure (&((*x).generic))))
            ...
            case TS_DECL_NON_COMMON:
              ...
              gt_ggc_m_13toplevel_node ((*x).generic.decl_non_common.common.symtab_node);
            ...
            case TS_DECL_WITH_VIS:
              ...
              gt_ggc_m_13toplevel_node ((*x).generic.decl_with_vis.symtab_node);
              break;
            case TS_VAR_DECL:
              ...
              gt_ggc_m_13toplevel_node ((*x).generic.var_decl.common.symtab_node);
              break;
            case TS_FIELD_DECL:
            ...
            case TS_TYPE_DECL:
              ...
              gt_ggc_m_13toplevel_node ((*x).generic.type_decl.common.common.symtab_node);
            ...
            case TS_FUNCTION_DECL:
              ...
              gt_ggc_m_13toplevel_node ((*x).generic.function_decl.common.common.symtab_node);
        ...
        case TS_D_GENERIC:
          switch ((int) (tree_node_structure (&((*x).generic))))
            ...
            case TS_DECL_NON_COMMON:
              ...
              gt_pch_n_13toplevel_node ((*x).generic.decl_non_common.common.symtab_node);
            ...
            case TS_DECL_WITH_VIS:
              ...
              gt_pch_n_13toplevel_node ((*x).generic.decl_with_vis.symtab_node);
              break;
            case TS_VAR_DECL:
              ...
              gt_pch_n_13toplevel_node ((*x).generic.var_decl.common.symtab_node);
              break;
            case TS_FIELD_DECL:
            ...
            case TS_TYPE_DECL:
              ...
              gt_pch_n_13toplevel_node ((*x).generic.type_decl.common.common.symtab_node);
            ...
            case TS_FUNCTION_DECL:
              ...
              gt_pch_n_13toplevel_node ((*x).generic.function_decl.common.common.symtab_node);
...
extern const struct ggc_root_tab gt_ggc_r_gt_riscv_vector_builtins_h[];
...
EXPORTED_CONST struct ggc_root_tab * const gt_ggc_rtab[] = {
  ...
  gt_ggc_r_gt_riscv_vector_builtins_h,
  gt_ggc_r_gtype_d_h,
...
extern const struct ggc_root_tab gt_pch_rs_gt_riscv_vector_builtins_h[];
EXPORTED_CONST struct ggc_root_tab * const gt_pch_scalar_rtab[] = {
  ...
  gt_pch_rs_gt_riscv_vector_builtins_h,
  NULL
};
