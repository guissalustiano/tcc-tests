  ...
  while (x != xlimit)
    {
      switch ((int) (gimple_statement_structure (&((*x)))))
        ...
        case GSS_OMP_TARGET:
          {
            gomp_target *sub = static_cast <gomp_target *> (x);
            (void) sub;
            gt_ggc_m_6gimple ((*sub).iterator_loops);
            gt_ggc_m_9tree_node ((*sub).clauses);
            gt_ggc_m_9tree_node ((*sub).child_fn);
            gt_ggc_m_9tree_node ((*sub).data_arg);
            gt_ggc_m_6gimple ((*sub).body);
...
void
gt_ggc_mx_toplevel_node (void *x_p)
{
  struct toplevel_node * x = (struct toplevel_node *)x_p;
  struct toplevel_node * xlimit = x;
  while (ggc_test_and_set_mark (xlimit))
   xlimit = ((*xlimit).next);
  if (x != xlimit)
    for (;;)
      {
        struct toplevel_node * const xprev = ((*x).previous);
        if (xprev == NULL) break;
        x = xprev;
        (void) ggc_test_and_set_mark (xprev);
      }
  while (x != xlimit)
    {
      switch ((int) (((*x)).type))
        ...
        case TOPLEVEL_BASE:
          ...
          gt_ggc_m_13toplevel_node ((*x).next);
          gt_ggc_m_13toplevel_node ((*x).previous);
          break;
        case TOPLEVEL_ASM:
          {
            asm_node *sub = static_cast <asm_node *> (x);
            (void) sub;
            gt_ggc_m_9tree_node ((*sub).asm_str);
            gt_ggc_m_18lto_file_decl_data ((*sub).lto_file_data);
            gt_ggc_m_13toplevel_node ((*sub).next);
            gt_ggc_m_13toplevel_node ((*sub).previous);
          }
          break;
        case SYMTAB_SYMBOL:
          {
            symtab_node *sub = static_cast <symtab_node *> (x);
            (void) sub;
            gt_ggc_m_9tree_node ((*sub).decl);
            gt_ggc_m_13toplevel_node ((*sub).next_sharing_asm_name);
            gt_ggc_m_13toplevel_node ((*sub).previous_sharing_asm_name);
            gt_ggc_m_13toplevel_node ((*sub).same_comdat_group);
        ...
        case SYMTAB_FUNCTION:
          {
            ...
            gt_ggc_m_13toplevel_node ((*sub).next_sibling_clone);
            gt_ggc_m_13toplevel_node ((*sub).prev_sibling_clone);
            gt_ggc_m_13toplevel_node ((*sub).clones);
            gt_ggc_m_13toplevel_node ((*sub).clone_of);
            ...
            gt_ggc_m_13toplevel_node ((*sub).simd_clones);
            gt_ggc_m_13toplevel_node ((*sub).inlined_to);
...
gt_ggc_mx_cgraph_edge (void *x_p)
{
  ...
  while (x != xlimit)
    {
      gt_ggc_m_13toplevel_node ((*x).caller);
      gt_ggc_m_13toplevel_node ((*x).callee);
...
gt_ggc_mx_cl_target_option (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_S ((*x).x_riscv_autovec_mode);
    ...
    {
      {
        ...
        gt_ggc_m_13toplevel_node ((*x).prev_clone);
        gt_ggc_m_13toplevel_node ((*x).next_clone);
        gt_ggc_m_13toplevel_node ((*x).origin);
        {
          size_t i0;
          for (i0 = 0; i0 != l0; i0++) {
...
gt_ggc_mx_cgraph_function_version_info (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_13toplevel_node ((*x).this_node);
      ...
      gt_ggc_m_9tree_node ((*x).assembler_name);
    }
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      switch ((int) (((*x)).kind))
        {
        case CIIK_UNSPECIFIED:
          break;
        case CIIK_POLYMORPHIC:
          {
            cgraph_polymorphic_indirect_info *sub = static_cast <cgraph_polymorphic_indirect_info *> (x);
            (void) sub;
            gt_ggc_m_9tree_node ((*sub).context.outer_type);
            gt_ggc_m_9tree_node ((*sub).context.speculative_outer_type);
            gt_ggc_m_9tree_node ((*sub).otr_type);
          }
          break;
        case CIIK_SIMPLE:
          {
            cgraph_simple_indirect_info *sub = static_cast <cgraph_simple_indirect_info *> (x);
            (void) sub;
            gt_ggc_m_9tree_node ((*sub).rec_type);
          }
          break;
        /* Unrecognized tag value.  */
        default: gcc_unreachable (); 
...
gt_ggc_mx_symbol_table (void *x_p)
{
  ...
  if (ggc_test_and_set_mark (x))
    {
      gt_ggc_m_13toplevel_node ((*x).nodes);
      gt_ggc_m_13toplevel_node ((*x).asmnodes);
      gt_ggc_m_13toplevel_node ((*x).asm_last_node);
...
{
  if (x)
    gt_ggc_mx_toplevel_node ((void *) x);
}
  ...
  if (ggc_test_and_set_mark (x))
    {
      ...
      switch ((int) (ctf_dtu_d_union_selector (&((*x)))))
        ...
        case CTF_DTU_D_SLICE:
          ...
          break;
        case CTF_DTU_D_TAG:
          gt_ggc_m_9ctf_dvdef ((*x).dtd_u.dtu_tag.ref_var);
          break;
        default:
          break;
        }
    ...
    {
      {
        ...
        gt_ggc_m_24vec_ctf_dtdef_ref_va_gc_ ((*x).ctfc_tags);
        gt_ggc_m_37hash_map_ctf_dtdef_ref_ctf_dtdef_ref_ ((*x).ctfc_type_tags_map);
...
gt_ggc_mx (struct ipa_agg_jf_item& x_r ATTRIBUTE_UNUSED)
{
  ...
  switch ((int) (((*x)).jftype))
    ...
    case IPA_JF_PASS_THROUGH:
      ...
      gt_ggc_m_9tree_node ((*x).value.pass_through.op_type);
      break;
    case IPA_JF_LOAD_AGG:
      gt_ggc_m_9tree_node ((*x).value.load_agg.pass_through.operand);
      gt_ggc_m_9tree_node ((*x).value.load_agg.pass_through.op_type);
        ...
        case GSS_OMP_TARGET:
          {
            gomp_target *sub = static_cast <gomp_target *> (x);
            (void) sub;
            gt_pch_n_6gimple ((*sub).iterator_loops);
            gt_pch_n_9tree_node ((*sub).clauses);
            gt_pch_n_9tree_node ((*sub).child_fn);
            gt_pch_n_9tree_node ((*sub).data_arg);
            gt_pch_n_6gimple ((*sub).body);
...
void
gt_pch_nx_toplevel_node (void *x_p)
{
  struct toplevel_node * x = (struct toplevel_node *)x_p;
  struct toplevel_node * xlimit = x;
  while (gt_pch_note_object (xlimit, xlimit, gt_pch_p_13toplevel_node))
   xlimit = ((*xlimit).next);
  if (x != xlimit)
    for (;;)
      {
        ...
        if (xprev == NULL) break;
        x = xprev;
        (void) gt_pch_note_object (xprev, xprev, gt_pch_p_13toplevel_node);
      }
  while (x != xlimit)
    {
      switch ((int) (((*x)).type))
        ...
        case TOPLEVEL_BASE:
          ...
          gt_pch_n_13toplevel_node ((*x).next);
          gt_pch_n_13toplevel_node ((*x).previous);
          break;
        case TOPLEVEL_ASM:
          {
            asm_node *sub = static_cast <asm_node *> (x);
            (void) sub;
            gt_pch_n_9tree_node ((*sub).asm_str);
            gt_pch_n_18lto_file_decl_data ((*sub).lto_file_data);
            gt_pch_n_13toplevel_node ((*sub).next);
            gt_pch_n_13toplevel_node ((*sub).previous);
          }
          break;
        case SYMTAB_SYMBOL:
          {
            ...
            gt_pch_n_13toplevel_node ((*sub).next_sharing_asm_name);
            gt_pch_n_13toplevel_node ((*sub).previous_sharing_asm_name);
            gt_pch_n_13toplevel_node ((*sub).same_comdat_group);
        ...
        case SYMTAB_FUNCTION:
          {
            ...
            gt_pch_n_13toplevel_node ((*sub).next_sibling_clone);
            gt_pch_n_13toplevel_node ((*sub).prev_sibling_clone);
            gt_pch_n_13toplevel_node ((*sub).clones);
            gt_pch_n_13toplevel_node ((*sub).clone_of);
            ...
            gt_pch_n_13toplevel_node ((*sub).simd_clones);
            gt_pch_n_13toplevel_node ((*sub).inlined_to);
...
gt_pch_nx_cgraph_edge (void *x_p)
{
  ...
  while (x != xlimit)
    {
      gt_pch_n_13toplevel_node ((*x).caller);
      gt_pch_n_13toplevel_node ((*x).callee);
...
gt_pch_nx_cl_target_option (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_16cl_target_option))
    {
      gt_pch_n_S ((*x).x_riscv_autovec_mode);
      gt_pch_n_S ((*x).x_riscv_arch_string);
      gt_pch_n_S ((*x).x_riscv_cpu_string);
      gt_pch_n_S ((*x).x_riscv_tune_string);
    }
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_17cgraph_simd_clone))
    {
      {
        size_t l0 = (size_t)(((*x)).nargs);
        gt_pch_n_13toplevel_node ((*x).prev_clone);
        gt_pch_n_13toplevel_node ((*x).next_clone);
        gt_pch_n_13toplevel_node ((*x).origin);
        {
          size_t i0;
          for (i0 = 0; i0 != l0; i0++) {
...
gt_pch_nx_cgraph_function_version_info (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_28cgraph_function_version_info))
    {
      gt_pch_n_13toplevel_node ((*x).this_node);
      ...
      gt_pch_n_9tree_node ((*x).assembler_name);
    }
}
        ...
        case CIIK_POLYMORPHIC:
          {
            cgraph_polymorphic_indirect_info *sub = static_cast <cgraph_polymorphic_indirect_info *> (x);
            (void) sub;
            gt_pch_n_9tree_node ((*sub).context.outer_type);
            gt_pch_n_9tree_node ((*sub).context.speculative_outer_type);
            gt_pch_n_9tree_node ((*sub).otr_type);
          }
          break;
        case CIIK_SIMPLE:
          {
            cgraph_simple_indirect_info *sub = static_cast <cgraph_simple_indirect_info *> (x);
            (void) sub;
            gt_pch_n_9tree_node ((*sub).rec_type);
          }
          break;
        /* Unrecognized tag value.  */
        default: gcc_unreachable (); 
...
gt_pch_nx_symbol_table (void *x_p)
{
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_12symbol_table))
    {
      gt_pch_n_13toplevel_node ((*x).nodes);
      gt_pch_n_13toplevel_node ((*x).asmnodes);
      gt_pch_n_13toplevel_node ((*x).asm_last_node);
...
{
  if (x)
    gt_pch_nx_toplevel_node ((void *) x);
}
  ...
  if (gt_pch_note_object (x, x, gt_pch_p_9ctf_dtdef))
    {
      ...
      switch ((int) (ctf_dtu_d_union_selector (&((*x)))))
        ...
        case CTF_DTU_D_SLICE:
          ...
          break;
        case CTF_DTU_D_TAG:
          gt_pch_n_9ctf_dvdef ((*x).dtd_u.dtu_tag.ref_var);
          break;
        default:
          break;
        }
    ...
    {
      {
        ...
        gt_pch_n_24vec_ctf_dtdef_ref_va_gc_ ((*x).ctfc_tags);
        gt_pch_n_37hash_map_ctf_dtdef_ref_ctf_dtdef_ref_ ((*x).ctfc_type_tags_map);
...
gt_pch_nx (struct ipa_agg_jf_item& x_r ATTRIBUTE_UNUSED)
{
  ...
  switch ((int) (((*x)).jftype))
    ...
    case IPA_JF_PASS_THROUGH:
      ...
      gt_pch_n_9tree_node ((*x).value.pass_through.op_type);
      break;
    case IPA_JF_LOAD_AGG:
      gt_pch_n_9tree_node ((*x).value.load_agg.pass_through.operand);
      gt_pch_n_9tree_node ((*x).value.load_agg.pass_through.op_type);
    ...
    case GSS_OMP_TARGET:
      {
        ...
        (void) sub;
        if ((void *)(x) == this_obj)
          op (&((*sub).iterator_loops), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).clauses), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).child_fn), NULL, cookie);
...
void
gt_pch_p_13toplevel_node (ATTRIBUTE_UNUSED void *this_obj,
	void *x_p,
	ATTRIBUTE_UNUSED gt_pointer_operator op,
	ATTRIBUTE_UNUSED void *cookie)
{
  struct toplevel_node * x ATTRIBUTE_UNUSED = (struct toplevel_node *)x_p;
  switch ((int) (((*x)).type))
    {
    case TOPLEVEL_BASE:
      if ((void *)(x) == this_obj)
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).x_riscv_autovec_mode), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_riscv_arch_string), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_riscv_cpu_string), NULL, cookie);
  if ((void *)(x) == this_obj)
    op (&((*x).x_riscv_tune_string), NULL, cookie);
}
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  if ((void *)(x) == this_obj)
    op (&((*x).assembler_name), NULL, cookie);
}
    ...
    case CIIK_POLYMORPHIC:
      {
        ...
        (void) sub;
        if ((void *)(x) == this_obj)
          op (&((*sub).context.outer_type), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).context.speculative_outer_type), NULL, cookie);
        if ((void *)(x) == this_obj)
          op (&((*sub).otr_type), NULL, cookie);
      }
      break;
    case CIIK_SIMPLE:
      {
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (ctf_dtu_d_union_selector (&((*x)))))
    ...
    case CTF_DTU_D_TAG:
      if ((void *)(x) == this_obj)
        op (&((*x).dtd_u.dtu_tag.ref_var), NULL, cookie);
      break;
    default:
      break;
    }
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  struct ctf_container * x ATTRIBUTE_UNUSED = (struct ctf_container *)x_p;
  {
    ...
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_tags), NULL, cookie);
    if ((void *)(x) == this_obj)
      op (&((*x).ctfc_type_tags_map), NULL, cookie);
    if ((void *)(x) == this_obj)
	...
	ATTRIBUTE_UNUSED void *cookie)
{
  ...
  switch ((int) (((*x)).jftype))
    ...
    case IPA_JF_PASS_THROUGH:
        ...
        op (&((*x).value.pass_through.op_type), NULL, cookie);
      break;
    case IPA_JF_LOAD_AGG:
        op (&((*x).value.load_agg.pass_through.operand), NULL, cookie);
        op (&((*x).value.load_agg.pass_through.op_type), NULL, cookie);
