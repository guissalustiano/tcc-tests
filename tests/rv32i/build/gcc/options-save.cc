		      ...
		      struct gcc_options *opts_set)
{
  ...
  gcc_assert (IN_RANGE (opts->x_flag_auto_profile_inlining, -128, 127));
  ...
  gcc_assert (IN_RANGE (opts->x_flag_dep_fusion, -128, 127));
  ...
  gcc_assert (IN_RANGE (opts->x_flag_ipa_reorder_for_locality, -128, 127));
  ...
  gcc_assert (IN_RANGE (opts->x_flag_speculatively_call_stored_functions, -128, 127));
  ...
  ptr->x_param_auto_profile_bbs = opts->x_param_auto_profile_bbs;
  ptr->x_param_auto_profile_reorder_only = opts->x_param_auto_profile_reorder_only;
  ...
  ptr->x_param_ipa_cp_sweeps = opts->x_param_ipa_cp_sweeps;
  ...
  ptr->x_lra_max_pseudos_points_log2_considered_for_preferences = opts->x_lra_max_pseudos_points_log2_considered_for_preferences;
  ptr->x_param_lto_locality_frequency = opts->x_param_lto_locality_frequency;
  ptr->x_param_lto_locality_size = opts->x_param_lto_locality_size;
  ...
  ptr->x_param_max_combine_search_insns = opts->x_param_max_combine_search_insns;
  ...
  ptr->x_param_max_devirt_targets = opts->x_param_max_devirt_targets;
  ...
  ptr->x_param_max_niter_dominators_walk = opts->x_param_max_niter_dominators_walk;
  ...
  ptr->x_param_memtag_instrument_mem_intrinsics = opts->x_param_memtag_instrument_mem_intrinsics;
  ...
  ptr->x_param_uninit_max_prune_work = opts->x_param_uninit_max_prune_work;
  ...
  ptr->x_param_vect_allow_possibly_not_worthwhile_vectorizations = opts->x_param_vect_allow_possibly_not_worthwhile_vectorizations;
  ptr->x_param_vrp_block_limit = opts->x_param_vrp_block_limit;
  ptr->x_param_vrp_cstload_limit = opts->x_param_vrp_cstload_limit;
  ...
  ptr->x_flag_complex_method = opts->x_flag_complex_method;
  ...
  ptr->x_flag_lto_locality_cloning = opts->x_flag_lto_locality_cloning;
  ptr->x_flag_lto_locality_heuristics = opts->x_flag_lto_locality_heuristics;
  ...
  ptr->x_flag_auto_profile_inlining = opts->x_flag_auto_profile_inlining;
  ...
  ptr->x_flag_dep_fusion = opts->x_flag_dep_fusion;
  ...
  ptr->x_flag_ipa_reorder_for_locality = opts->x_flag_ipa_reorder_for_locality;
  ...
  ptr->x_flag_speculatively_call_stored_functions = opts->x_flag_speculatively_call_stored_functions;
  ...
  if (opts_set->x_param_auto_profile_bbs) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_auto_profile_reorder_only) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_avg_loop_niter) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_avoid_fma_max_bits) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_builtin_expect_probability) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_builtin_string_cmp_inline_length) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_case_values_threshold) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_comdat_sharing_probability) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_construct_interfere_size) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_cycle_accurate_model) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_destruct_interfere_size) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_dse_max_alias_queries_per_store) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_dse_max_object_size) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_early_inlining_insns) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_fsm_scale_path_stmts) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_fully_pipelined_fma) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_gcse_after_reload_critical_fraction) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_gcse_after_reload_partial_fraction) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_gcse_cost_distance_ratio) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_gcse_unrestricted_cost) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_graphite_max_arrays_per_scop) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_graphite_max_nb_scop_params) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_hardcfr_max_blocks) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_hardcfr_max_inline_blocks) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_hwasan_instrument_allocas) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_hwasan_instrument_mem_intrinsics) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_hwasan_instrument_reads) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_hwasan_instrument_stack) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_hwasan_instrument_writes) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_hwasan_random_frame_tag) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_inline_heuristics_hint_percent) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_inline_min_speedup) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_inline_unit_growth) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_ipa_cp_eval_threshold) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_ipa_cp_large_unit_insns) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_ipa_cp_loop_hint_bonus) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_ipa_cp_max_recursive_depth) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_ipa_cp_min_recursive_probability) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_ipa_cp_recursion_penalty) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_ipa_cp_recursive_freq_factor) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_ipa_cp_single_call_penalty) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_ipa_cp_sweeps) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_ipa_cp_unit_growth) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_ipa_cp_value_list_size) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_ipa_jump_function_lookups) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_ipa_max_aa_steps) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_ipa_max_agg_items) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_ipa_max_loop_predicates) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_ipa_max_param_expr_ops) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_ipa_max_switch_predicate_bounds) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_ipa_sra_deref_prob_threshold) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_ipa_sra_max_replacements) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_ipa_sra_ptr_growth_factor) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_ipa_sra_ptrwrap_growth_factor) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[0] = mask;
  mask = 0;
  if (opts_set->x_param_ira_consider_dup_in_all_alts) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_ira_loop_reserved_regs) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_ira_max_conflict_table_size) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_ira_max_loops_num) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_ira_simple_lra_insn_threshold) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_iv_always_prune_cand_set_bound) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_iv_consider_all_candidates_bound) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_iv_max_considered_uses) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_jump_table_max_growth_ratio_for_size) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_jump_table_max_growth_ratio_for_speed) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_l1_cache_line_size) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_l1_cache_size) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_l2_cache_size) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_large_function_growth) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_large_function_insns) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_stack_frame_growth) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_large_stack_frame) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_large_unit_insns) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_lim_expensive) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_loop_block_tile_size) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_loop_interchange_max_num_stmts) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_loop_interchange_stride_ratio) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_loop_invariant_max_bbs_in_loop) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_loop_max_datarefs_for_datadeps) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_loop_versioning_max_inner_insns) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_loop_versioning_max_outer_insns) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_lra_inheritance_ebb_probability_cutoff) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_lra_max_considered_reload_pseudos) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_lra_max_pseudos_points_log2_considered_for_preferences) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_lto_locality_frequency) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_lto_locality_size) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_max_average_unrolled_insns) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_max_combine_insns) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_max_combine_search_insns) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_max_unroll_iterations) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_max_completely_peel_times) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_max_completely_peeled_insns) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_max_crossjump_edges) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_max_cse_insns) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_max_cse_path_length) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_max_cselib_memory_locations) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_max_debug_marker_count) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_max_delay_slot_insn_search) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_max_delay_slot_live_search) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_max_devirt_targets) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_max_dse_active_local_stores) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_early_inliner_max_iterations) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_max_find_base_term_values) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_max_fsm_thread_path_insns) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_max_gcse_insertion_ratio) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_max_gcse_memory) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_max_goto_duplication_insns) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_max_grow_copy_bb_insns) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_max_hoist_depth) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_inline_functions_called_once_insns) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_inline_functions_called_once_loop_depth) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_max_inline_insns_auto) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_max_inline_insns_recursive_auto) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_max_inline_insns_recursive) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_max_inline_insns_single) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_max_inline_insns_size) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_max_inline_insns_small) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_max_inline_recursive_depth_auto) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_max_inline_recursive_depth) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[1] = mask;
  mask = 0;
  if (opts_set->x_param_max_isl_operations) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_max_iterations_computation_cost) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_max_iterations_to_track) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_max_jump_thread_duplication_stmts) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_max_jump_thread_paths) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_max_last_value_rtl) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_max_loop_header_insns) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_max_modulo_backtrack_attempts) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_max_niter_dominators_walk) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_max_partial_antic_length) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_max_peel_branches) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_max_peel_times) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_max_peeled_insns) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_max_pending_list_length) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_max_pipeline_region_blocks) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_max_pipeline_region_insns) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_max_pow_sqrt_depth) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_max_predicted_iterations) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_max_reload_search_insns) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_max_rtl_if_conversion_insns) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_max_rtl_if_conversion_predictable_cost) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_max_rtl_if_conversion_unpredictable_cost) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_max_sched_extend_regions_iters) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_max_sched_insn_conflict_delay) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_max_sched_ready_insns) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_max_sched_region_blocks) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_max_sched_region_insns) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_max_slsr_candidate_scan) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_max_speculative_devirt_maydefs) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_max_stores_to_merge) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_max_stores_to_sink) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_max_tail_merge_comparisons) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_max_tail_merge_iterations) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_max_tracked_strlens) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_max_tree_if_conversion_phi_args) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_max_unroll_times) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_max_unrolled_insns) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_max_unswitch_depth) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_max_unswitch_insns) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_max_variable_expansions) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_max_vartrack_expr_depth) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_max_vartrack_reverse_op_size) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_max_vartrack_size) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_memtag_instrument_mem_intrinsics) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_min_crossjump_insns) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_min_inline_recursive_probability) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_min_insn_to_prefetch_ratio) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_min_loop_cond_split_prob) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_min_pagesize) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_min_size_for_stack_sharing) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_min_spec_prob) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_min_vect_loop_bound) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_modref_max_accesses) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_modref_max_adjustments) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_modref_max_bases) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_modref_max_depth) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_modref_max_escape_points) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_modref_max_refs) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_modref_max_tests) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_parloops_chunk_size) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_parloops_min_per_thread) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_parloops_schedule) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_partial_inlining_entry_probability) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_phiopt_factor_max_stmts_live) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[2] = mask;
  mask = 0;
  if (opts_set->x_param_predictable_branch_outcome) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_prefetch_dynamic_strides) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_prefetch_latency) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_prefetch_min_insn_to_mem_ratio) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_prefetch_minimum_stride) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_ranger_logical_depth) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_ranger_recompute_depth) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_relation_block_limit) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_param_rpo_vn_max_loop_depth) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_param_sccvn_max_alias_queries_per_access) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_param_scev_max_expr_complexity) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_param_scev_max_expr_size) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_param_sched_autopref_queue_depth) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_param_sched_mem_true_dep_cost) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_param_sched_pressure_algorithm) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_param_sched_spec_prob_cutoff) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_param_sched_state_edge_prob_cutoff) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_selsched_insns_to_rename) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_selsched_max_lookahead) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_param_selsched_max_sched_times) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_param_simultaneous_prefetches) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_param_sink_frequency_threshold) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_param_sms_dfa_history) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_param_sms_loop_average_count_threshold) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_param_sms_max_ii_factor) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_param_sms_min_sc) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_param_sra_max_propagations) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_param_sra_max_scalarization_size_size) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_param_sra_max_scalarization_size_speed) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_param_ssa_name_def_chain_limit) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_param_ssp_buffer_size) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_param_stack_clash_protection_guard_size) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_param_stack_clash_protection_probe_interval) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_param_store_forwarding_max_distance) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_param_store_merging_allow_unaligned) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_param_store_merging_max_size) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_param_switch_conversion_branch_ratio) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_param_tm_max_aggregate_size) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_param_tracer_dynamic_coverage_feedback) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_param_tracer_dynamic_coverage) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_param_tracer_max_code_growth) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_param_tracer_min_branch_probability_feedback) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_param_tracer_min_branch_probability) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_param_tracer_min_branch_ratio) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_param_transitive_relations_work_bound) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_param_tree_reassoc_width) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_param_uninit_control_dep_attempts) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_param_uninit_max_chain_len) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_param_uninit_max_num_chains) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_param_uninit_max_prune_work) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_param_uninlined_function_insns) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_param_uninlined_function_time) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_param_uninlined_function_thunk_insns) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_param_uninlined_function_thunk_time) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_param_unlikely_bb_count_fraction) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_param_unroll_jam_max_unroll) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_param_unroll_jam_min_percent) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_param_use_after_scope_direct_emission_threshold) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_param_vect_epilogues_nomask) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_param_vect_induction_float) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_param_vect_inner_loop_cost_factor) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_param_vect_max_layout_candidates) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_param_vect_max_peeling_for_alignment) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_param_vect_max_version_for_alias_checks) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[3] = mask;
  mask = 0;
  if (opts_set->x_param_vect_max_version_for_alignment_checks) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_param_vect_partial_vector_usage) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_param_vect_allow_possibly_not_worthwhile_vectorizations) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_param_vrp_block_limit) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_param_vrp_cstload_limit) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_param_vrp_sparse_threshold) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_param_vrp_switch_limit) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_param_vrp_vector_threshold) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_complex_method) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_malloc_dse) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_min_function_alignment) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_openmp_target_simd_clone) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_sched_stalled_insns) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_sched_stalled_insns_dep) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_tree_parallelize_loops) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_lto_locality_cloning) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_lto_locality_heuristics) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_param_ranger_debug) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_param_threader_debug) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_excess_precision) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_fp_contract_mode) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_harden_control_flow_redundancy_check_noreturn) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_inline_stringops) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_ira_algorithm) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_ira_region) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_live_patching) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_reorder_blocks_algorithm) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_simd_cost_model) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_stack_reuse) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_auto_var_init) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_vect_cost_model) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_optimize) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_optimize_size) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_optimize_debug) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_optimize_fast) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_warn_inline) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_aggressive_loop_optimizations) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_align_functions) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_align_jumps) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_align_labels) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_align_loops) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_allocation_dce) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_store_data_races) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_associative_math) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_assume_sane_operators_new_delete) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_asynchronous_unwind_tables) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_auto_inc_dec) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_auto_profile_inlining) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_avoid_store_forwarding) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_bit_tests) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_branch_on_count_reg) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_branch_probabilities) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_caller_saves) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_code_hoisting) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_combine_stack_adjustments) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_compare_elim_after_reload) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_conserve_stack) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_cprop_registers) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_crossjumping) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_cse_follow_jumps) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_dce) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_defer_pop) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_delayed_branch) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_delete_dead_exceptions) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[4] = mask;
  mask = 0;
  if (opts_set->x_flag_delete_null_pointer_checks) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_dep_fusion) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_devirtualize) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_devirtualize_speculatively) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_dse) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_early_inlining) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_exceptions) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_expensive_optimizations) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_ext_dce) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_finite_loops) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_finite_math_only) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_float_store) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_fold_mem_offsets) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_fold_simple_inlines) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_forward_propagate) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_fp_int_builtin_inexact) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_no_function_cse) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_gcse) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_gcse_after_reload) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_gcse_las) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_gcse_lm) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_gcse_sm) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_graphite) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_graphite_identity) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_guess_branch_prob) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_harden_control_flow_redundancy_check_exceptions) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_harden_control_flow_redundancy_check_returning_calls) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_harden_control_flow_redundancy_skip_leaf) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_harden_compares) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_harden_conditional_branches) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_harden_control_flow_redundancy) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_hoist_adjacent_loads) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_if_conversion) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_if_conversion2) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_indirect_inlining) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_no_inline) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_inline_atomics) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_inline_functions) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_inline_functions_called_once) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_inline_small_functions) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_ipa_bit_cp) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_ipa_cp) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_ipa_cp_clone) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_ipa_icf) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_ipa_icf_functions) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_ipa_icf_variables) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_ipa_modref) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_ipa_profile) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_ipa_pta) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_ipa_pure_const) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_ipa_ra) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_ipa_reference) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_ipa_reference_addressable) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_ipa_reorder_for_locality) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_ipa_sra) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_ipa_stack_alignment) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_ipa_strict_aliasing) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_ipa_vrp) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_ira_hoist_pressure) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_ira_loop_pressure) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_ira_share_save_slots) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_ira_share_spill_slots) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_isolate_erroneous_paths_attribute) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_isolate_erroneous_paths_dereference) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[5] = mask;
  mask = 0;
  if (opts_set->x_flag_ivopts) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_jump_tables) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_keep_gc_roots_live) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_late_combine_instructions) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_lifetime_dse) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_limit_function_alignment) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_live_range_shrinkage) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_loop_interchange) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_loop_nest_optimize) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_loop_parallelize_all) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_unroll_jam) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_lra_remat) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_malloc_dce) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_errno_math) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_modulo_sched) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_modulo_sched_allow_regmoves) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_move_loop_invariants) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_move_loop_stores) mask |= HOST_WIDE_INT_1U << 17;
  ...
  if (opts_set->x_flag_optimize_crc) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_optimize_sibling_calls) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_optimize_strlen) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_pack_struct) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_partial_inlining) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_pcc_struct_return) mask |= HOST_WIDE_INT_1U << 27;
  ...
  if (opts_set->x_flag_rename_registers) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_reorder_blocks) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_reorder_blocks_and_partition) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_reorder_functions) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_rerun_cse_after_loop) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_resched_modulo_sched) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_rounding_math) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_rtti) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_save_optimization_record) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_sched_critical_path_heuristic) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_sched_dep_count_heuristic) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_sched_group_heuristic) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_schedule_interblock) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_sched_last_insn_heuristic) mask |= HOST_WIDE_INT_1U << 52;
  if (opts_set->x_flag_sched_pressure) mask |= HOST_WIDE_INT_1U << 53;
  if (opts_set->x_flag_sched_rank_heuristic) mask |= HOST_WIDE_INT_1U << 54;
  if (opts_set->x_flag_schedule_speculative) mask |= HOST_WIDE_INT_1U << 55;
  if (opts_set->x_flag_sched_spec_insn_heuristic) mask |= HOST_WIDE_INT_1U << 56;
  if (opts_set->x_flag_schedule_speculative_load) mask |= HOST_WIDE_INT_1U << 57;
  if (opts_set->x_flag_schedule_speculative_load_dangerous) mask |= HOST_WIDE_INT_1U << 58;
  if (opts_set->x_flag_sched2_use_superblocks) mask |= HOST_WIDE_INT_1U << 59;
  if (opts_set->x_flag_schedule_fusion) mask |= HOST_WIDE_INT_1U << 60;
  if (opts_set->x_flag_schedule_insns) mask |= HOST_WIDE_INT_1U << 61;
  if (opts_set->x_flag_schedule_insns_after_reload) mask |= HOST_WIDE_INT_1U << 62;
  if (opts_set->x_flag_section_anchors) mask |= HOST_WIDE_INT_1U << 63;
  ptr->explicit_mask[6] = mask;
  mask = 0;
  if (opts_set->x_flag_sel_sched_pipelining) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_flag_sel_sched_pipelining_outer_loops) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_flag_sel_sched_reschedule_pipelined) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_selective_scheduling) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_selective_scheduling2) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_semantic_interposition) mask |= HOST_WIDE_INT_1U << 5;
  ...
  if (opts_set->x_flag_speculatively_call_stored_functions) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_split_ivs_in_unroller) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_split_loops) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_split_paths) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_split_wide_types) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_split_wide_types_early) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_ssa_backprop) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_ssa_phiopt) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_stack_clash_protection) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_flag_stack_protect) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_flag_stdarg_opt) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_flag_store_merging) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_flag_strict_aliasing) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_flag_strict_enums) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_strict_volatile_bitfields) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_flag_thread_jumps) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_flag_threadsafe_statics) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_flag_toplevel_reorder) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_flag_tracer) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_flag_trapping_math) mask |= HOST_WIDE_INT_1U << 32;
  if (opts_set->x_flag_trapv) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_flag_tree_bit_ccp) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_flag_tree_builtin_call_dce) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_flag_tree_ccp) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_flag_tree_ch) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_flag_tree_coalesce_vars) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_flag_tree_copy_prop) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_flag_tree_cselim) mask |= HOST_WIDE_INT_1U << 40;
  if (opts_set->x_flag_tree_dce) mask |= HOST_WIDE_INT_1U << 41;
  if (opts_set->x_flag_tree_dom) mask |= HOST_WIDE_INT_1U << 42;
  if (opts_set->x_flag_tree_dse) mask |= HOST_WIDE_INT_1U << 43;
  if (opts_set->x_flag_tree_forwprop) mask |= HOST_WIDE_INT_1U << 44;
  if (opts_set->x_flag_tree_fre) mask |= HOST_WIDE_INT_1U << 45;
  if (opts_set->x_flag_tree_loop_distribute_patterns) mask |= HOST_WIDE_INT_1U << 46;
  if (opts_set->x_flag_tree_loop_distribution) mask |= HOST_WIDE_INT_1U << 47;
  if (opts_set->x_flag_tree_loop_if_convert) mask |= HOST_WIDE_INT_1U << 48;
  if (opts_set->x_flag_tree_loop_im) mask |= HOST_WIDE_INT_1U << 49;
  if (opts_set->x_flag_tree_loop_ivcanon) mask |= HOST_WIDE_INT_1U << 50;
  if (opts_set->x_flag_tree_loop_optimize) mask |= HOST_WIDE_INT_1U << 51;
  if (opts_set->x_flag_tree_loop_vectorize) mask |= HOST_WIDE_INT_1U << 52;
  ...
  if (opts_set->x_flag_tree_vectorize) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_flag_tree_vrp) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_flag_unconstrained_commons) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_flag_unreachable_traps) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_flag_unroll_all_loops) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_flag_cunroll_grow_size) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_flag_unroll_loops) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_flag_unsafe_math_optimizations) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_flag_unswitch_loops) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_flag_unwind_tables) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_flag_var_tracking) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_flag_var_tracking_assignments) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_flag_var_tracking_assignments_toggle) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_flag_var_tracking_uninit) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_flag_variable_expansion_in_unroller) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_flag_version_loops_for_strides) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_flag_value_profile_transformations) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_flag_web) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_flag_wrapv) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_flag_wrapv_pointer) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_debug_nonbind_markers_p) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_str_align_functions) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_str_align_jumps) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_str_align_labels) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_str_align_loops) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_flag_patchable_function_entry) mask |= HOST_WIDE_INT_1U << 27;
			 ...
			 struct cl_optimization *ptr)
{
  ...
  opts->x_param_auto_profile_bbs = ptr->x_param_auto_profile_bbs;
  opts->x_param_auto_profile_reorder_only = ptr->x_param_auto_profile_reorder_only;
  ...
  opts->x_param_ipa_cp_sweeps = ptr->x_param_ipa_cp_sweeps;
  ...
  opts->x_lra_max_pseudos_points_log2_considered_for_preferences = ptr->x_lra_max_pseudos_points_log2_considered_for_preferences;
  opts->x_param_lto_locality_frequency = ptr->x_param_lto_locality_frequency;
  opts->x_param_lto_locality_size = ptr->x_param_lto_locality_size;
  ...
  opts->x_param_max_combine_search_insns = ptr->x_param_max_combine_search_insns;
  ...
  opts->x_param_max_devirt_targets = ptr->x_param_max_devirt_targets;
  ...
  opts->x_param_max_niter_dominators_walk = ptr->x_param_max_niter_dominators_walk;
  ...
  opts->x_param_memtag_instrument_mem_intrinsics = ptr->x_param_memtag_instrument_mem_intrinsics;
  ...
  opts->x_param_uninit_max_prune_work = ptr->x_param_uninit_max_prune_work;
  ...
  opts->x_param_vect_allow_possibly_not_worthwhile_vectorizations = ptr->x_param_vect_allow_possibly_not_worthwhile_vectorizations;
  opts->x_param_vrp_block_limit = ptr->x_param_vrp_block_limit;
  opts->x_param_vrp_cstload_limit = ptr->x_param_vrp_cstload_limit;
  ...
  opts->x_flag_complex_method = ptr->x_flag_complex_method;
  ...
  opts->x_flag_lto_locality_cloning = ptr->x_flag_lto_locality_cloning;
  opts->x_flag_lto_locality_heuristics = ptr->x_flag_lto_locality_heuristics;
  ...
  opts->x_flag_auto_profile_inlining = ptr->x_flag_auto_profile_inlining;
  ...
  opts->x_flag_dep_fusion = ptr->x_flag_dep_fusion;
  ...
  opts->x_flag_ipa_reorder_for_locality = ptr->x_flag_ipa_reorder_for_locality;
  ...
  opts->x_flag_speculatively_call_stored_functions = ptr->x_flag_speculatively_call_stored_functions;
  ...
  mask >>= 1;
  opts_set->x_param_auto_profile_bbs = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_auto_profile_reorder_only = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_ipa_cp_sweeps = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_lra_max_pseudos_points_log2_considered_for_preferences = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_lto_locality_frequency = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_lto_locality_size = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_max_average_unrolled_insns = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_max_combine_insns = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_max_combine_search_insns = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_max_devirt_targets = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_max_niter_dominators_walk = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_memtag_instrument_mem_intrinsics = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_uninit_max_prune_work = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_param_vect_allow_possibly_not_worthwhile_vectorizations = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_vrp_block_limit = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_param_vrp_cstload_limit = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_complex_method = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_lto_locality_cloning = static_cast<enum lto_locality_cloning_model >((mask & 1) != 0);
  mask >>= 1;
  opts_set->x_flag_lto_locality_heuristics = static_cast<enum lto_locality_heuristics >((mask & 1) != 0);
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_auto_profile_inlining = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_dep_fusion = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_ipa_reorder_for_locality = (mask & 1) != 0;
  mask >>= 1;
  ...
  mask >>= 1;
  opts_set->x_flag_speculatively_call_stored_functions = (mask & 1) != 0;
  mask >>= 1;
                       ...
                       struct cl_optimization *ptr)
{
  ...
  if (ptr->x_param_auto_profile_bbs)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_auto_profile_bbs",
             ptr->x_param_auto_profile_bbs);

  if (ptr->x_param_auto_profile_reorder_only)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_auto_profile_reorder_only",
             ptr->x_param_auto_profile_reorder_only);
  ...
  if (ptr->x_param_ipa_cp_sweeps)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_ipa_cp_sweeps",
             ptr->x_param_ipa_cp_sweeps);
  ...
  if (ptr->x_lra_max_pseudos_points_log2_considered_for_preferences)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "lra_max_pseudos_points_log2_considered_for_preferences",
             ptr->x_lra_max_pseudos_points_log2_considered_for_preferences);

  if (ptr->x_param_lto_locality_frequency)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_lto_locality_frequency",
             ptr->x_param_lto_locality_frequency);

  if (ptr->x_param_lto_locality_size)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_lto_locality_size",
             ptr->x_param_lto_locality_size);
  ...
  if (ptr->x_param_max_combine_search_insns)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_max_combine_search_insns",
             ptr->x_param_max_combine_search_insns);
  ...
  if (ptr->x_param_max_devirt_targets)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_max_devirt_targets",
             ptr->x_param_max_devirt_targets);
  ...
  if (ptr->x_param_max_niter_dominators_walk)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_max_niter_dominators_walk",
             ptr->x_param_max_niter_dominators_walk);
  ...
  if (ptr->x_param_memtag_instrument_mem_intrinsics)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_memtag_instrument_mem_intrinsics",
             ptr->x_param_memtag_instrument_mem_intrinsics);
  ...
  if (ptr->x_param_uninit_max_prune_work)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_uninit_max_prune_work",
             ptr->x_param_uninit_max_prune_work);
  ...
  if (ptr->x_param_vect_allow_possibly_not_worthwhile_vectorizations)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_vect_allow_possibly_not_worthwhile_vectorizations",
             ptr->x_param_vect_allow_possibly_not_worthwhile_vectorizations);
  ...
  if (ptr->x_param_vrp_cstload_limit)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "param_vrp_cstload_limit",
             ptr->x_param_vrp_cstload_limit);
  ...
  if (ptr->x_flag_complex_method)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_complex_method",
             ptr->x_flag_complex_method);
  ...
  fprintf (file, "%*s%s (%#x)\n",
           ...
           (int) ptr->x_flag_lto_locality_cloning);

  fprintf (file, "%*s%s (%#x)\n",
           indent_to, "",
           "flag_lto_locality_heuristics",
           (int) ptr->x_flag_lto_locality_heuristics);
  ...
  if (ptr->x_flag_auto_profile_inlining)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_auto_profile_inlining",
             ptr->x_flag_auto_profile_inlining);
  ...
  if (ptr->x_flag_dep_fusion)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_dep_fusion",
             ptr->x_flag_dep_fusion);
  ...
  if (ptr->x_flag_ipa_reorder_for_locality)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_ipa_reorder_for_locality",
             ptr->x_flag_ipa_reorder_for_locality);
  ...
  if (ptr->x_flag_speculatively_call_stored_functions)
    fprintf (file, "%*s%s (%#x)\n",
             indent_to, "",
             "flag_speculatively_call_stored_functions",
             ptr->x_flag_speculatively_call_stored_functions);
                            ...
                            struct cl_optimization *ptr2)
{
  ...
  if (ptr1->x_param_auto_profile_bbs != ptr2->x_param_auto_profile_bbs)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_auto_profile_bbs",
             ptr1->x_param_auto_profile_bbs,
             ptr2->x_param_auto_profile_bbs);

  if (ptr1->x_param_auto_profile_reorder_only != ptr2->x_param_auto_profile_reorder_only)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_auto_profile_reorder_only",
             ptr1->x_param_auto_profile_reorder_only,
             ptr2->x_param_auto_profile_reorder_only);
  ...
  if (ptr1->x_param_ipa_cp_sweeps != ptr2->x_param_ipa_cp_sweeps)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_ipa_cp_sweeps",
             ptr1->x_param_ipa_cp_sweeps,
             ptr2->x_param_ipa_cp_sweeps);
  ...
  if (ptr1->x_lra_max_pseudos_points_log2_considered_for_preferences != ptr2->x_lra_max_pseudos_points_log2_considered_for_preferences)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "lra_max_pseudos_points_log2_considered_for_preferences",
             ptr1->x_lra_max_pseudos_points_log2_considered_for_preferences,
             ptr2->x_lra_max_pseudos_points_log2_considered_for_preferences);

  if (ptr1->x_param_lto_locality_frequency != ptr2->x_param_lto_locality_frequency)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_lto_locality_frequency",
             ptr1->x_param_lto_locality_frequency,
             ptr2->x_param_lto_locality_frequency);

  if (ptr1->x_param_lto_locality_size != ptr2->x_param_lto_locality_size)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_lto_locality_size",
             ptr1->x_param_lto_locality_size,
             ptr2->x_param_lto_locality_size);
  ...
  if (ptr1->x_param_max_combine_search_insns != ptr2->x_param_max_combine_search_insns)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_max_combine_search_insns",
             ptr1->x_param_max_combine_search_insns,
             ptr2->x_param_max_combine_search_insns);
  ...
  if (ptr1->x_param_max_devirt_targets != ptr2->x_param_max_devirt_targets)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_max_devirt_targets",
             ptr1->x_param_max_devirt_targets,
             ptr2->x_param_max_devirt_targets);
  ...
  if (ptr1->x_param_max_niter_dominators_walk != ptr2->x_param_max_niter_dominators_walk)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_max_niter_dominators_walk",
             ptr1->x_param_max_niter_dominators_walk,
             ptr2->x_param_max_niter_dominators_walk);
  ...
  if (ptr1->x_param_memtag_instrument_mem_intrinsics != ptr2->x_param_memtag_instrument_mem_intrinsics)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_memtag_instrument_mem_intrinsics",
             ptr1->x_param_memtag_instrument_mem_intrinsics,
             ptr2->x_param_memtag_instrument_mem_intrinsics);
  ...
  if (ptr1->x_param_uninit_max_prune_work != ptr2->x_param_uninit_max_prune_work)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_uninit_max_prune_work",
             ptr1->x_param_uninit_max_prune_work,
             ptr2->x_param_uninit_max_prune_work);
  ...
  if (ptr1->x_param_vect_allow_possibly_not_worthwhile_vectorizations != ptr2->x_param_vect_allow_possibly_not_worthwhile_vectorizations)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_vect_allow_possibly_not_worthwhile_vectorizations",
             ptr1->x_param_vect_allow_possibly_not_worthwhile_vectorizations,
             ptr2->x_param_vect_allow_possibly_not_worthwhile_vectorizations);
  ...
  if (ptr1->x_param_vrp_cstload_limit != ptr2->x_param_vrp_cstload_limit)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "param_vrp_cstload_limit",
             ptr1->x_param_vrp_cstload_limit,
             ptr2->x_param_vrp_cstload_limit);
  ...
  if (ptr1->x_flag_complex_method != ptr2->x_flag_complex_method)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_complex_method",
             ptr1->x_flag_complex_method,
             ptr2->x_flag_complex_method);
  ...
  if (ptr1->x_flag_lto_locality_cloning != ptr2->x_flag_lto_locality_cloning)
  fprintf (file, "%*s%s (%#x/%#x)\n",
           indent_to, "",
           "flag_lto_locality_cloning",
           (int) ptr1->x_flag_lto_locality_cloning,
           (int) ptr2->x_flag_lto_locality_cloning);

  if (ptr1->x_flag_lto_locality_heuristics != ptr2->x_flag_lto_locality_heuristics)
  fprintf (file, "%*s%s (%#x/%#x)\n",
           indent_to, "",
           "flag_lto_locality_heuristics",
           (int) ptr1->x_flag_lto_locality_heuristics,
           (int) ptr2->x_flag_lto_locality_heuristics);
  ...
  if (ptr1->x_flag_auto_profile_inlining != ptr2->x_flag_auto_profile_inlining)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_auto_profile_inlining",
             ptr1->x_flag_auto_profile_inlining,
             ptr2->x_flag_auto_profile_inlining);
  ...
  if (ptr1->x_flag_dep_fusion != ptr2->x_flag_dep_fusion)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_dep_fusion",
             ptr1->x_flag_dep_fusion,
             ptr2->x_flag_dep_fusion);
  ...
  if (ptr1->x_flag_ipa_reorder_for_locality != ptr2->x_flag_ipa_reorder_for_locality)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_ipa_reorder_for_locality",
             ptr1->x_flag_ipa_reorder_for_locality,
             ptr2->x_flag_ipa_reorder_for_locality);
  ...
  if (ptr1->x_flag_speculatively_call_stored_functions != ptr2->x_flag_speculatively_call_stored_functions)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent_to, "",
             "flag_speculatively_call_stored_functions",
             ptr1->x_flag_speculatively_call_stored_functions,
             ptr2->x_flag_speculatively_call_stored_functions);
...
cl_target_option_save (struct cl_target_option *ptr, struct gcc_options *opts,
		       struct gcc_options *opts_set)
{
  gcc_assert (IN_RANGE (opts->x_riscv_max_vectorization, -128, 127));
  gcc_assert (IN_RANGE (opts->x_rvv_vector_strict_align, -128, 127));

  if (targetm.target_option.save)
    targetm.target_option.save (ptr, opts, opts_set);

  ptr->x_riscv_base_subext = opts->x_riscv_base_subext;
  ptr->x_riscv_fmv_priority = opts->x_riscv_fmv_priority;
  ptr->x_riscv_isa_flags = opts->x_riscv_isa_flags;
  ptr->x_riscv_sd_subext = opts->x_riscv_sd_subext;
  ptr->x_riscv_sh_subext = opts->x_riscv_sh_subext;
  ptr->x_riscv_sm_subext = opts->x_riscv_sm_subext;
  ptr->x_riscv_ss_subext = opts->x_riscv_ss_subext;
  ptr->x_riscv_stack_protector_guard_reg = opts->x_riscv_stack_protector_guard_reg;
  ptr->x_riscv_su_subext = opts->x_riscv_su_subext;
  ptr->x_riscv_sv_subext = opts->x_riscv_sv_subext;
  ptr->x_riscv_vector_elen_flags = opts->x_riscv_vector_elen_flags;
  ptr->x_riscv_xandes_subext = opts->x_riscv_xandes_subext;
  ptr->x_riscv_xcv_subext = opts->x_riscv_xcv_subext;
  ptr->x_riscv_xmips_subext = opts->x_riscv_xmips_subext;
  ptr->x_riscv_xsf_subext = opts->x_riscv_xsf_subext;
  ptr->x_riscv_xsmt_subext = opts->x_riscv_xsmt_subext;
  ...
  ptr->x_riscv_zt_subext = opts->x_riscv_zt_subext;
  ptr->x_riscv_zvb_subext = opts->x_riscv_zvb_subext;
  ptr->x_riscv_zve_subext = opts->x_riscv_zve_subext;
  ptr->x_riscv_zvf_subext = opts->x_riscv_zvf_subext;
  ptr->x_riscv_zvk_subext = opts->x_riscv_zvk_subext;
  ptr->x_riscv_zvl_subext = opts->x_riscv_zvl_subext;
  ptr->x_riscv_stack_protector_guard_offset = opts->x_riscv_stack_protector_guard_offset;
  ptr->x_target_flags = opts->x_target_flags;
  ptr->x_riscv_cmodel = opts->x_riscv_cmodel;
  ptr->x_riscv_tls_dialect = opts->x_riscv_tls_dialect;
  ptr->x_riscv_max_vectorization = opts->x_riscv_max_vectorization;
  ptr->x_rvv_vector_strict_align = opts->x_rvv_vector_strict_align;
  ptr->x_riscv_autovec_mode = opts->x_riscv_autovec_mode;
  ...
  unsigned HOST_WIDE_INT mask = 0;
  if (opts_set->x_riscv_base_subext) mask |= HOST_WIDE_INT_1U << 0;
  if (opts_set->x_riscv_fmv_priority) mask |= HOST_WIDE_INT_1U << 1;
  if (opts_set->x_riscv_isa_flags) mask |= HOST_WIDE_INT_1U << 2;
  if (opts_set->x_riscv_sd_subext) mask |= HOST_WIDE_INT_1U << 3;
  if (opts_set->x_riscv_sh_subext) mask |= HOST_WIDE_INT_1U << 4;
  if (opts_set->x_riscv_sm_subext) mask |= HOST_WIDE_INT_1U << 5;
  if (opts_set->x_riscv_ss_subext) mask |= HOST_WIDE_INT_1U << 6;
  if (opts_set->x_riscv_stack_protector_guard_reg) mask |= HOST_WIDE_INT_1U << 7;
  if (opts_set->x_riscv_su_subext) mask |= HOST_WIDE_INT_1U << 8;
  if (opts_set->x_riscv_sv_subext) mask |= HOST_WIDE_INT_1U << 9;
  if (opts_set->x_riscv_vector_elen_flags) mask |= HOST_WIDE_INT_1U << 10;
  if (opts_set->x_riscv_xandes_subext) mask |= HOST_WIDE_INT_1U << 11;
  if (opts_set->x_riscv_xcv_subext) mask |= HOST_WIDE_INT_1U << 12;
  if (opts_set->x_riscv_xmips_subext) mask |= HOST_WIDE_INT_1U << 13;
  if (opts_set->x_riscv_xsf_subext) mask |= HOST_WIDE_INT_1U << 14;
  if (opts_set->x_riscv_xsmt_subext) mask |= HOST_WIDE_INT_1U << 15;
  if (opts_set->x_riscv_xthead_subext) mask |= HOST_WIDE_INT_1U << 16;
  if (opts_set->x_riscv_xventana_subext) mask |= HOST_WIDE_INT_1U << 17;
  if (opts_set->x_riscv_za_subext) mask |= HOST_WIDE_INT_1U << 18;
  if (opts_set->x_riscv_zb_subext) mask |= HOST_WIDE_INT_1U << 19;
  if (opts_set->x_riscv_zc_subext) mask |= HOST_WIDE_INT_1U << 20;
  if (opts_set->x_riscv_zf_subext) mask |= HOST_WIDE_INT_1U << 21;
  if (opts_set->x_riscv_zi_subext) mask |= HOST_WIDE_INT_1U << 22;
  if (opts_set->x_riscv_zinx_subext) mask |= HOST_WIDE_INT_1U << 23;
  if (opts_set->x_riscv_zk_subext) mask |= HOST_WIDE_INT_1U << 24;
  if (opts_set->x_riscv_zm_subext) mask |= HOST_WIDE_INT_1U << 25;
  if (opts_set->x_riscv_zt_subext) mask |= HOST_WIDE_INT_1U << 26;
  if (opts_set->x_riscv_zvb_subext) mask |= HOST_WIDE_INT_1U << 27;
  if (opts_set->x_riscv_zve_subext) mask |= HOST_WIDE_INT_1U << 28;
  if (opts_set->x_riscv_zvf_subext) mask |= HOST_WIDE_INT_1U << 29;
  if (opts_set->x_riscv_zvk_subext) mask |= HOST_WIDE_INT_1U << 30;
  if (opts_set->x_riscv_zvl_subext) mask |= HOST_WIDE_INT_1U << 31;
  if (opts_set->x_riscv_stack_protector_guard_offset) mask |= HOST_WIDE_INT_1U << 32;
  ptr->explicit_mask_target_flags = opts_set->x_target_flags;
  if (opts_set->x_riscv_cmodel) mask |= HOST_WIDE_INT_1U << 33;
  if (opts_set->x_riscv_tls_dialect) mask |= HOST_WIDE_INT_1U << 34;
  if (opts_set->x_riscv_max_vectorization) mask |= HOST_WIDE_INT_1U << 35;
  if (opts_set->x_rvv_vector_strict_align) mask |= HOST_WIDE_INT_1U << 36;
  if (opts_set->x_riscv_autovec_mode) mask |= HOST_WIDE_INT_1U << 37;
  if (opts_set->x_riscv_arch_string) mask |= HOST_WIDE_INT_1U << 38;
  if (opts_set->x_riscv_cpu_string) mask |= HOST_WIDE_INT_1U << 39;
  if (opts_set->x_riscv_tune_string) mask |= HOST_WIDE_INT_1U << 40;
  ptr->explicit_mask[0] = mask;
}
...
{
  opts->x_riscv_base_subext = ptr->x_riscv_base_subext;
  opts->x_riscv_fmv_priority = ptr->x_riscv_fmv_priority;
  opts->x_riscv_isa_flags = ptr->x_riscv_isa_flags;
  opts->x_riscv_sd_subext = ptr->x_riscv_sd_subext;
  opts->x_riscv_sh_subext = ptr->x_riscv_sh_subext;
  opts->x_riscv_sm_subext = ptr->x_riscv_sm_subext;
  opts->x_riscv_ss_subext = ptr->x_riscv_ss_subext;
  opts->x_riscv_stack_protector_guard_reg = ptr->x_riscv_stack_protector_guard_reg;
  opts->x_riscv_su_subext = ptr->x_riscv_su_subext;
  opts->x_riscv_sv_subext = ptr->x_riscv_sv_subext;
  opts->x_riscv_vector_elen_flags = ptr->x_riscv_vector_elen_flags;
  opts->x_riscv_xandes_subext = ptr->x_riscv_xandes_subext;
  opts->x_riscv_xcv_subext = ptr->x_riscv_xcv_subext;
  opts->x_riscv_xmips_subext = ptr->x_riscv_xmips_subext;
  opts->x_riscv_xsf_subext = ptr->x_riscv_xsf_subext;
  opts->x_riscv_xsmt_subext = ptr->x_riscv_xsmt_subext;
  ...
  opts->x_riscv_zt_subext = ptr->x_riscv_zt_subext;
  opts->x_riscv_zvb_subext = ptr->x_riscv_zvb_subext;
  opts->x_riscv_zve_subext = ptr->x_riscv_zve_subext;
  opts->x_riscv_zvf_subext = ptr->x_riscv_zvf_subext;
  opts->x_riscv_zvk_subext = ptr->x_riscv_zvk_subext;
  opts->x_riscv_zvl_subext = ptr->x_riscv_zvl_subext;
  opts->x_riscv_stack_protector_guard_offset = ptr->x_riscv_stack_protector_guard_offset;
  opts->x_target_flags = ptr->x_target_flags;
  opts->x_riscv_cmodel = ptr->x_riscv_cmodel;
  opts->x_riscv_tls_dialect = ptr->x_riscv_tls_dialect;
  opts->x_riscv_max_vectorization = ptr->x_riscv_max_vectorization;
  opts->x_rvv_vector_strict_align = ptr->x_rvv_vector_strict_align;
  opts->x_riscv_autovec_mode = ptr->x_riscv_autovec_mode;
  opts->x_riscv_arch_string = ptr->x_riscv_arch_string;
  opts->x_riscv_cpu_string = ptr->x_riscv_cpu_string;
  opts->x_riscv_tune_string = ptr->x_riscv_tune_string;

  unsigned HOST_WIDE_INT mask;
  mask = ptr->explicit_mask[0];
  opts_set->x_riscv_base_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_fmv_priority = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_isa_flags = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_sd_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_sh_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_sm_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_ss_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_stack_protector_guard_reg = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_su_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_sv_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_vector_elen_flags = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_xandes_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_xcv_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_xmips_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_xsf_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_xsmt_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_xthead_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_xventana_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_za_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zb_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zc_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zf_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zi_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zinx_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zk_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zm_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zt_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zvb_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zve_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zvf_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zvk_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_zvl_subext = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_stack_protector_guard_offset = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_target_flags = ptr->explicit_mask_target_flags;
  opts_set->x_riscv_cmodel = static_cast<enum riscv_code_model >((mask & 1) != 0);
  mask >>= 1;
  opts_set->x_riscv_tls_dialect = static_cast<enum riscv_tls_type >((mask & 1) != 0);
  mask >>= 1;
  opts_set->x_riscv_max_vectorization = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_rvv_vector_strict_align = (mask & 1) != 0;
  mask >>= 1;
  opts_set->x_riscv_autovec_mode = (mask & 1) ? "" : nullptr;
  mask >>= 1;
  opts_set->x_riscv_arch_string = (mask & 1) ? "" : nullptr;
  mask >>= 1;
  opts_set->x_riscv_cpu_string = (mask & 1) ? "" : nullptr;
  mask >>= 1;
  opts_set->x_riscv_tune_string = (mask & 1) ? "" : nullptr;
  mask >>= 1;
                        ...
                        struct cl_target_option *ptr)
{
  ...
  if (ptr->x_riscv_cmodel)
    fprintf (file, "%*s%s (%#x)\n",
             indent, "",
             "riscv_cmodel",
             ptr->x_riscv_cmodel);

  if (ptr->x_riscv_tls_dialect)
    fprintf (file, "%*s%s (%#x)\n",
             indent, "",
             "riscv_tls_dialect",
             ptr->x_riscv_tls_dialect);

  if (ptr->x_riscv_max_vectorization)
    fprintf (file, "%*s%s (%#x)\n",
             indent, "",
             "riscv_max_vectorization",
             ptr->x_riscv_max_vectorization);

  if (ptr->x_rvv_vector_strict_align)
    fprintf (file, "%*s%s (%#x)\n",
             indent, "",
             "rvv_vector_strict_align",
             ptr->x_rvv_vector_strict_align);

  if (ptr->x_riscv_autovec_mode)
    fprintf (file, "%*s%s (%s)\n",
             indent, "",
             "riscv_autovec_mode",
             ptr->x_riscv_autovec_mode);

  if (ptr->x_riscv_arch_string)
    fprintf (file, "%*s%s (%s)\n",
             indent, "",
             "riscv_arch_string",
             ptr->x_riscv_arch_string);

  if (ptr->x_riscv_cpu_string)
    fprintf (file, "%*s%s (%s)\n",
             indent, "",
             "riscv_cpu_string",
             ptr->x_riscv_cpu_string);

  if (ptr->x_riscv_tune_string)
    fprintf (file, "%*s%s (%s)\n",
             indent, "",
             "riscv_tune_string",
             ptr->x_riscv_tune_string);
                             ...
                             struct cl_target_option *ptr2 ATTRIBUTE_UNUSED)
{
  ...
  if (ptr1->x_riscv_tls_dialect != ptr2->x_riscv_tls_dialect)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent, "",
             "riscv_tls_dialect",
             ptr1->x_riscv_tls_dialect,
             ptr2->x_riscv_tls_dialect);

  if (ptr1->x_riscv_max_vectorization != ptr2->x_riscv_max_vectorization)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent, "",
             "riscv_max_vectorization",
             ptr1->x_riscv_max_vectorization,
             ptr2->x_riscv_max_vectorization);

  if (ptr1->x_rvv_vector_strict_align != ptr2->x_rvv_vector_strict_align)
    fprintf (file, "%*s%s (%#x/%#x)\n",
             indent, "",
             "rvv_vector_strict_align",
             ptr1->x_rvv_vector_strict_align,
             ptr2->x_rvv_vector_strict_align);

  if (ptr1->x_riscv_autovec_mode != ptr2->x_riscv_autovec_mode
      && (!ptr1->x_riscv_autovec_mode || !ptr2->x_riscv_autovec_mode
          || strcmp (ptr1->x_riscv_autovec_mode, ptr2->x_riscv_autovec_mode)))
    fprintf (file, "%*s%s (%s/%s)\n",
             indent, "",
             "riscv_autovec_mode",
             ptr1->x_riscv_autovec_mode ? ptr1->x_riscv_autovec_mode : "(null)",
             ptr2->x_riscv_autovec_mode ? ptr2->x_riscv_autovec_mode : "(null)");

  if (ptr1->x_riscv_arch_string != ptr2->x_riscv_arch_string
      && (!ptr1->x_riscv_arch_string || !ptr2->x_riscv_arch_string
          || strcmp (ptr1->x_riscv_arch_string, ptr2->x_riscv_arch_string)))
    fprintf (file, "%*s%s (%s/%s)\n",
             indent, "",
             "riscv_arch_string",
             ptr1->x_riscv_arch_string ? ptr1->x_riscv_arch_string : "(null)",
             ptr2->x_riscv_arch_string ? ptr2->x_riscv_arch_string : "(null)");

  if (ptr1->x_riscv_cpu_string != ptr2->x_riscv_cpu_string
      && (!ptr1->x_riscv_cpu_string || !ptr2->x_riscv_cpu_string
          || strcmp (ptr1->x_riscv_cpu_string, ptr2->x_riscv_cpu_string)))
    fprintf (file, "%*s%s (%s/%s)\n",
             indent, "",
             "riscv_cpu_string",
             ptr1->x_riscv_cpu_string ? ptr1->x_riscv_cpu_string : "(null)",
             ptr2->x_riscv_cpu_string ? ptr2->x_riscv_cpu_string : "(null)");

  if (ptr1->x_riscv_tune_string != ptr2->x_riscv_tune_string
      && (!ptr1->x_riscv_tune_string || !ptr2->x_riscv_tune_string
          || strcmp (ptr1->x_riscv_tune_string, ptr2->x_riscv_tune_string)))
    fprintf (file, "%*s%s (%s/%s)\n",
             indent, "",
             "riscv_tune_string",
             ptr1->x_riscv_tune_string ? ptr1->x_riscv_tune_string : "(null)",
             ptr2->x_riscv_tune_string ? ptr2->x_riscv_tune_string : "(null)");
                     ...
                     struct cl_target_option const *ptr2 ATTRIBUTE_UNUSED)
{
  ...
  if (ptr1->x_riscv_tune_string != ptr2->x_riscv_tune_string
      && (!ptr1->x_riscv_tune_string || !ptr2->x_riscv_tune_string
          || strcmp (ptr1->x_riscv_tune_string, ptr2->x_riscv_tune_string)))
    return false;
  if (ptr1->x_riscv_base_subext != ptr2->x_riscv_base_subext)
    return false;
  if (ptr1->x_riscv_fmv_priority != ptr2->x_riscv_fmv_priority)
    return false;
  if (ptr1->x_riscv_isa_flags != ptr2->x_riscv_isa_flags)
    return false;
  if (ptr1->x_riscv_sd_subext != ptr2->x_riscv_sd_subext)
    return false;
  if (ptr1->x_riscv_sh_subext != ptr2->x_riscv_sh_subext)
    return false;
  if (ptr1->x_riscv_sm_subext != ptr2->x_riscv_sm_subext)
    return false;
  if (ptr1->x_riscv_ss_subext != ptr2->x_riscv_ss_subext)
    return false;
  if (ptr1->x_riscv_stack_protector_guard_reg != ptr2->x_riscv_stack_protector_guard_reg)
    return false;
  if (ptr1->x_riscv_su_subext != ptr2->x_riscv_su_subext)
    return false;
  if (ptr1->x_riscv_sv_subext != ptr2->x_riscv_sv_subext)
    return false;
  if (ptr1->x_riscv_vector_elen_flags != ptr2->x_riscv_vector_elen_flags)
    return false;
  if (ptr1->x_riscv_xandes_subext != ptr2->x_riscv_xandes_subext)
    return false;
  if (ptr1->x_riscv_xcv_subext != ptr2->x_riscv_xcv_subext)
    return false;
  if (ptr1->x_riscv_xmips_subext != ptr2->x_riscv_xmips_subext)
    return false;
  if (ptr1->x_riscv_xsf_subext != ptr2->x_riscv_xsf_subext)
    return false;
  if (ptr1->x_riscv_xsmt_subext != ptr2->x_riscv_xsmt_subext)
    return false;
  if (ptr1->x_riscv_xthead_subext != ptr2->x_riscv_xthead_subext)
    return false;
  if (ptr1->x_riscv_xventana_subext != ptr2->x_riscv_xventana_subext)
    return false;
  if (ptr1->x_riscv_za_subext != ptr2->x_riscv_za_subext)
    return false;
  if (ptr1->x_riscv_zb_subext != ptr2->x_riscv_zb_subext)
    return false;
  if (ptr1->x_riscv_zc_subext != ptr2->x_riscv_zc_subext)
    return false;
  if (ptr1->x_riscv_zf_subext != ptr2->x_riscv_zf_subext)
    return false;
  if (ptr1->x_riscv_zi_subext != ptr2->x_riscv_zi_subext)
    return false;
  if (ptr1->x_riscv_zinx_subext != ptr2->x_riscv_zinx_subext)
    return false;
  if (ptr1->x_riscv_zk_subext != ptr2->x_riscv_zk_subext)
    return false;
  if (ptr1->x_riscv_zm_subext != ptr2->x_riscv_zm_subext)
    return false;
  if (ptr1->x_riscv_zt_subext != ptr2->x_riscv_zt_subext)
    return false;
  if (ptr1->x_riscv_zvb_subext != ptr2->x_riscv_zvb_subext)
    return false;
  if (ptr1->x_riscv_zve_subext != ptr2->x_riscv_zve_subext)
    return false;
  if (ptr1->x_riscv_zvf_subext != ptr2->x_riscv_zvf_subext)
    return false;
  if (ptr1->x_riscv_zvk_subext != ptr2->x_riscv_zvk_subext)
    return false;
  if (ptr1->x_riscv_zvl_subext != ptr2->x_riscv_zvl_subext)
    return false;
...
cl_target_option_hash (struct cl_target_option const *ptr ATTRIBUTE_UNUSED)
{
  inchash::hash hstate;
  if (ptr->x_riscv_autovec_mode)
    hstate.add (ptr->x_riscv_autovec_mode, strlen (ptr->x_riscv_autovec_mode));
  else
    hstate.add_int (0);
  if (ptr->x_riscv_arch_string)
    hstate.add (ptr->x_riscv_arch_string, strlen (ptr->x_riscv_arch_string));
  else
    hstate.add_int (0);
  if (ptr->x_riscv_cpu_string)
    hstate.add (ptr->x_riscv_cpu_string, strlen (ptr->x_riscv_cpu_string));
  else
    hstate.add_int (0);
  if (ptr->x_riscv_tune_string)
    hstate.add (ptr->x_riscv_tune_string, strlen (ptr->x_riscv_tune_string));
  else
    hstate.add_int (0);
  hstate.add_hwi (ptr->x_riscv_base_subext);
  hstate.add_hwi (ptr->x_riscv_fmv_priority);
  hstate.add_hwi (ptr->x_riscv_isa_flags);
  hstate.add_hwi (ptr->x_riscv_sd_subext);
  hstate.add_hwi (ptr->x_riscv_sh_subext);
  hstate.add_hwi (ptr->x_riscv_sm_subext);
  hstate.add_hwi (ptr->x_riscv_ss_subext);
  hstate.add_hwi (ptr->x_riscv_stack_protector_guard_reg);
  hstate.add_hwi (ptr->x_riscv_su_subext);
  hstate.add_hwi (ptr->x_riscv_sv_subext);
  hstate.add_hwi (ptr->x_riscv_vector_elen_flags);
  hstate.add_hwi (ptr->x_riscv_xandes_subext);
  hstate.add_hwi (ptr->x_riscv_xcv_subext);
  hstate.add_hwi (ptr->x_riscv_xmips_subext);
  hstate.add_hwi (ptr->x_riscv_xsf_subext);
  hstate.add_hwi (ptr->x_riscv_xsmt_subext);
  hstate.add_hwi (ptr->x_riscv_xthead_subext);
  hstate.add_hwi (ptr->x_riscv_xventana_subext);
  hstate.add_hwi (ptr->x_riscv_za_subext);
  hstate.add_hwi (ptr->x_riscv_zb_subext);
  hstate.add_hwi (ptr->x_riscv_zc_subext);
  hstate.add_hwi (ptr->x_riscv_zf_subext);
  hstate.add_hwi (ptr->x_riscv_zi_subext);
  hstate.add_hwi (ptr->x_riscv_zinx_subext);
  hstate.add_hwi (ptr->x_riscv_zk_subext);
  hstate.add_hwi (ptr->x_riscv_zm_subext);
  hstate.add_hwi (ptr->x_riscv_zt_subext);
  hstate.add_hwi (ptr->x_riscv_zvb_subext);
  hstate.add_hwi (ptr->x_riscv_zve_subext);
  hstate.add_hwi (ptr->x_riscv_zvf_subext);
  hstate.add_hwi (ptr->x_riscv_zvk_subext);
  hstate.add_hwi (ptr->x_riscv_zvl_subext);
  hstate.add_hwi (ptr->x_riscv_stack_protector_guard_offset);
  hstate.add_hwi (ptr->x_riscv_cmodel);
  hstate.add_hwi (ptr->x_riscv_max_vectorization);
  hstate.add_hwi (ptr->x_target_flags);
  hstate.add_hwi (ptr->x_riscv_tls_dialect);
  hstate.add_hwi (ptr->x_rvv_vector_strict_align);
...
{
  bp_pack_string (ob, bp, ptr->x_riscv_autovec_mode, true);
  bp_pack_string (ob, bp, ptr->x_riscv_arch_string, true);
  bp_pack_string (ob, bp, ptr->x_riscv_cpu_string, true);
  bp_pack_string (ob, bp, ptr->x_riscv_tune_string, true);
  bp_pack_value (bp, ptr->x_riscv_base_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_fmv_priority, 64);
  bp_pack_value (bp, ptr->x_riscv_isa_flags, 64);
  bp_pack_value (bp, ptr->x_riscv_sd_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_sh_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_sm_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_ss_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_stack_protector_guard_reg, 64);
  bp_pack_value (bp, ptr->x_riscv_su_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_sv_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_vector_elen_flags, 64);
  bp_pack_value (bp, ptr->x_riscv_xandes_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_xcv_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_xmips_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_xsf_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_xsmt_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_xthead_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_xventana_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_za_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zb_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zc_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zf_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zi_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zinx_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zk_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zm_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zt_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zvb_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zve_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zvf_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zvk_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_zvl_subext, 64);
  bp_pack_value (bp, ptr->x_riscv_stack_protector_guard_offset, 64);
  bp_pack_value (bp, ptr->x_riscv_cmodel, 64);
  bp_pack_value (bp, ptr->x_riscv_max_vectorization, 64);
  bp_pack_value (bp, ptr->x_target_flags, 64);
  bp_pack_value (bp, ptr->x_riscv_tls_dialect, 64);
  bp_pack_value (bp, ptr->x_rvv_vector_strict_align, 64);
  for (size_t i = 0; i < ARRAY_SIZE (ptr->explicit_mask); i++)
...
cl_target_option_stream_in (struct data_in *data_in ATTRIBUTE_UNUSED,
                            ...
                            struct cl_target_option *ptr ATTRIBUTE_UNUSED)
{
  ptr->x_riscv_autovec_mode = bp_unpack_string (data_in, bp);
  if (ptr->x_riscv_autovec_mode)
    ptr->x_riscv_autovec_mode = xstrdup (ptr->x_riscv_autovec_mode);
  ptr->x_riscv_arch_string = bp_unpack_string (data_in, bp);
  if (ptr->x_riscv_arch_string)
    ptr->x_riscv_arch_string = xstrdup (ptr->x_riscv_arch_string);
  ptr->x_riscv_cpu_string = bp_unpack_string (data_in, bp);
  if (ptr->x_riscv_cpu_string)
    ptr->x_riscv_cpu_string = xstrdup (ptr->x_riscv_cpu_string);
  ptr->x_riscv_tune_string = bp_unpack_string (data_in, bp);
  if (ptr->x_riscv_tune_string)
    ptr->x_riscv_tune_string = xstrdup (ptr->x_riscv_tune_string);
  ptr->x_riscv_base_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_fmv_priority = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_isa_flags = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_sd_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_sh_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_sm_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_ss_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_stack_protector_guard_reg = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_su_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_sv_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_vector_elen_flags = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_xandes_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_xcv_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_xmips_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_xsf_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_xsmt_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_xthead_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_xventana_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_za_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zb_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zc_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zf_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zi_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zinx_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zk_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zm_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zt_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zvb_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zve_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zvf_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zvk_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_zvl_subext = (int) bp_unpack_value (bp, 64);
  ptr->x_riscv_stack_protector_guard_offset = (long) bp_unpack_value (bp, 64);
  ptr->x_riscv_cmodel = (enum riscv_code_model ) bp_unpack_value (bp, 64);
  ptr->x_riscv_max_vectorization = (signed char ) bp_unpack_value (bp, 64);
  ptr->x_target_flags = (/* - */ int ) bp_unpack_value (bp, 64);
  ptr->x_riscv_tls_dialect = (enum riscv_tls_type ) bp_unpack_value (bp, 64);
  ptr->x_rvv_vector_strict_align = (signed char ) bp_unpack_value (bp, 64);
  for (size_t i = 0; i < ARRAY_SIZE (ptr->explicit_mask); i++)
...
{
  if (ptr->x_riscv_autovec_mode)
    free (const_cast <char *>(ptr->x_riscv_autovec_mode));
  if (ptr->x_riscv_arch_string)
    free (const_cast <char *>(ptr->x_riscv_arch_string));
  if (ptr->x_riscv_cpu_string)
    free (const_cast <char *>(ptr->x_riscv_cpu_string));
  if (ptr->x_riscv_tune_string)
    free (const_cast <char *>(ptr->x_riscv_tune_string));
}
...
cl_optimization_hash (struct cl_optimization const *ptr ATTRIBUTE_UNUSED)
{
  ...
  hstate.add_hwi (ptr->x_param_auto_profile_bbs);
  hstate.add_hwi (ptr->x_param_auto_profile_reorder_only);
  ...
  hstate.add_hwi (ptr->x_param_ipa_cp_sweeps);
  ...
  hstate.add_hwi (ptr->x_lra_max_pseudos_points_log2_considered_for_preferences);
  hstate.add_hwi (ptr->x_flag_lto_locality_cloning);
  hstate.add_hwi (ptr->x_param_lto_locality_frequency);
  hstate.add_hwi (ptr->x_flag_lto_locality_heuristics);
  hstate.add_hwi (ptr->x_param_lto_locality_size);
  hstate.add_hwi (ptr->x_param_max_average_unrolled_insns);
  hstate.add_hwi (ptr->x_param_max_combine_insns);
  hstate.add_hwi (ptr->x_param_max_combine_search_insns);
  ...
  hstate.add_hwi (ptr->x_param_max_devirt_targets);
  ...
  hstate.add_hwi (ptr->x_param_max_niter_dominators_walk);
  ...
  hstate.add_hwi (ptr->x_param_memtag_instrument_mem_intrinsics);
  ...
  hstate.add_hwi (ptr->x_param_uninit_max_prune_work);
  ...
  hstate.add_hwi (ptr->x_param_vect_allow_possibly_not_worthwhile_vectorizations);
  hstate.add_hwi (ptr->x_param_vrp_block_limit);
  hstate.add_hwi (ptr->x_param_vrp_cstload_limit);
  ...
  hstate.add_hwi (ptr->x_flag_auto_profile_inlining);
  ...
  hstate.add_hwi (ptr->x_flag_complex_method);
  ...
  hstate.add_hwi (ptr->x_flag_dep_fusion);
  ...
  hstate.add_hwi (ptr->x_flag_ipa_reorder_for_locality);
  ...
  hstate.add_hwi (ptr->x_flag_speculatively_call_stored_functions);
                            ...
                            struct cl_optimization *ptr)
{
  ...
  if (1 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_auto_profile_bbs ^ 1);
  else
    bp_pack_var_len_int (bp, ptr->x_param_auto_profile_bbs);
  if (0 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_auto_profile_reorder_only ^ 0);
  else
    bp_pack_var_len_int (bp, ptr->x_param_auto_profile_reorder_only);
  if (10 > (int ) 10)
  ...
  if (3 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_ipa_cp_sweeps ^ 3);
  else
    bp_pack_var_len_int (bp, ptr->x_param_ipa_cp_sweeps);
  if (10 > (int ) 10)
  ...
  if (30 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_lra_max_pseudos_points_log2_considered_for_preferences ^ 30);
  else
    bp_pack_var_len_int (bp, ptr->x_lra_max_pseudos_points_log2_considered_for_preferences);
  bp_pack_var_len_int (bp, ptr->x_flag_lto_locality_cloning);
  if (1 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_lto_locality_frequency ^ 1);
  else
    bp_pack_var_len_int (bp, ptr->x_param_lto_locality_frequency);
  bp_pack_var_len_int (bp, ptr->x_flag_lto_locality_heuristics);
  if (1000 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_lto_locality_size ^ 1000);
  else
    bp_pack_var_len_int (bp, ptr->x_param_lto_locality_size);
  if (80 > (int ) 10)
  ...
  if (3000 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_max_combine_search_insns ^ 3000);
  else
    bp_pack_var_len_int (bp, ptr->x_param_max_combine_search_insns);
  if (8 > (int ) 10)
  ...
  if (3 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_max_devirt_targets ^ 3);
  else
    bp_pack_var_len_int (bp, ptr->x_param_max_devirt_targets);
  if (5000 > (int ) 10)
  ...
  if (8 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_max_niter_dominators_walk ^ 8);
  else
    bp_pack_var_len_int (bp, ptr->x_param_max_niter_dominators_walk);
  if (100 > (int ) 10)
  ...
  if (1 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_memtag_instrument_mem_intrinsics ^ 1);
  else
    bp_pack_var_len_int (bp, ptr->x_param_memtag_instrument_mem_intrinsics);
  if (5 > (int ) 10)
  ...
  if (12 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_uninit_max_chain_len ^ 12);
  else
  ...
  if (100000 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_uninit_max_prune_work ^ 100000);
  else
    bp_pack_var_len_int (bp, ptr->x_param_uninit_max_prune_work);
  if (2 > (int ) 10)
  ...
  if (0 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_vect_allow_possibly_not_worthwhile_vectorizations ^ 0);
  else
    bp_pack_var_len_int (bp, ptr->x_param_vect_allow_possibly_not_worthwhile_vectorizations);
  if (150000 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_vrp_block_limit ^ 150000);
  else
    bp_pack_var_len_int (bp, ptr->x_param_vrp_block_limit);
  if (32 > (int ) 10)
    bp_pack_var_len_int (bp, ptr->x_param_vrp_cstload_limit ^ 32);
  else
    bp_pack_var_len_int (bp, ptr->x_param_vrp_cstload_limit);
  if (3000 > (int ) 10)
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_auto_profile_inlining);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_complex_method);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_dep_fusion);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_ipa_reorder_for_locality);
  ...
  bp_pack_var_len_int (bp, ptr->x_flag_speculatively_call_stored_functions);
                           ...
                           struct cl_optimization *ptr ATTRIBUTE_UNUSED)
{
  ...
  ptr->x_param_auto_profile_bbs = (int ) bp_unpack_var_len_int (bp);
  if (1 > (int ) 10)
    ptr->x_param_auto_profile_bbs ^= 1;
  ptr->x_param_auto_profile_reorder_only = (int ) bp_unpack_var_len_int (bp);
  if (0 > (int ) 10)
    ptr->x_param_auto_profile_reorder_only ^= 0;
  ...
  ptr->x_param_ipa_cp_sweeps = (int ) bp_unpack_var_len_int (bp);
  if (3 > (int ) 10)
    ptr->x_param_ipa_cp_sweeps ^= 3;
  ...
  ptr->x_lra_max_pseudos_points_log2_considered_for_preferences = (int ) bp_unpack_var_len_int (bp);
  if (30 > (int ) 10)
    ptr->x_lra_max_pseudos_points_log2_considered_for_preferences ^= 30;
  ptr->x_flag_lto_locality_cloning = (enum lto_locality_cloning_model ) bp_unpack_var_len_int (bp);
  ptr->x_param_lto_locality_frequency = (int ) bp_unpack_var_len_int (bp);
  if (1 > (int ) 10)
    ptr->x_param_lto_locality_frequency ^= 1;
  ptr->x_flag_lto_locality_heuristics = (enum lto_locality_heuristics ) bp_unpack_var_len_int (bp);
  ptr->x_param_lto_locality_size = (int ) bp_unpack_var_len_int (bp);
  if (1000 > (int ) 10)
    ptr->x_param_lto_locality_size ^= 1000;
  ...
  ptr->x_param_max_combine_search_insns = (int ) bp_unpack_var_len_int (bp);
  if (3000 > (int ) 10)
    ptr->x_param_max_combine_search_insns ^= 3000;
  ...
  ptr->x_param_max_devirt_targets = (int ) bp_unpack_var_len_int (bp);
  if (3 > (int ) 10)
    ptr->x_param_max_devirt_targets ^= 3;
  ...
  ptr->x_param_max_niter_dominators_walk = (int ) bp_unpack_var_len_int (bp);
  if (8 > (int ) 10)
    ptr->x_param_max_niter_dominators_walk ^= 8;
  ...
  ptr->x_param_memtag_instrument_mem_intrinsics = (int ) bp_unpack_var_len_int (bp);
  if (1 > (int ) 10)
    ptr->x_param_memtag_instrument_mem_intrinsics ^= 1;
  ...
  if (12 > (int ) 10)
    ptr->x_param_uninit_max_chain_len ^= 12;
  ptr->x_param_uninit_max_num_chains = (int ) bp_unpack_var_len_int (bp);
  if (8 > (int ) 10)
    ptr->x_param_uninit_max_num_chains ^= 8;
  ptr->x_param_uninit_max_prune_work = (int ) bp_unpack_var_len_int (bp);
  if (100000 > (int ) 10)
    ptr->x_param_uninit_max_prune_work ^= 100000;
  ...
  ptr->x_param_vect_epilogues_nomask = global_options.x_param_vect_epilogues_nomask;
#else
...
#ifdef ACCEL_COMPILER
  ptr->x_param_vect_inner_loop_cost_factor = global_options.x_param_vect_inner_loop_cost_factor;
#else
...
#ifdef ACCEL_COMPILER
  ptr->x_param_vect_partial_vector_usage = global_options.x_param_vect_partial_vector_usage;
#else
  ptr->x_param_vect_partial_vector_usage = (int ) bp_unpack_var_len_int (bp);
  if (2 > (int ) 10)
    ptr->x_param_vect_partial_vector_usage ^= 2;
#endif
  ptr->x_param_vect_allow_possibly_not_worthwhile_vectorizations = (int ) bp_unpack_var_len_int (bp);
  if (0 > (int ) 10)
    ptr->x_param_vect_allow_possibly_not_worthwhile_vectorizations ^= 0;
  ptr->x_param_vrp_block_limit = (int ) bp_unpack_var_len_int (bp);
  if (150000 > (int ) 10)
    ptr->x_param_vrp_block_limit ^= 150000;
  ptr->x_param_vrp_cstload_limit = (int ) bp_unpack_var_len_int (bp);
  if (32 > (int ) 10)
    ptr->x_param_vrp_cstload_limit ^= 32;
  ...
  ptr->x_flag_auto_profile_inlining = (signed char ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_complex_method = (int ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_dep_fusion = (signed char ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_ipa_reorder_for_locality = (signed char ) bp_unpack_var_len_int (bp);
  ...
  ptr->x_flag_speculatively_call_stored_functions = (signed char ) bp_unpack_var_len_int (bp);
...
cl_optimization_compare (gcc_options *ptr1, gcc_options *ptr2)
{
  ...
  if (ptr1->x_param_file_cache_lines != ptr2->x_param_file_cache_lines)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_fpr2vr_cost != ptr2->x_fpr2vr_cost)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_fsm_scale_path_stmts != ptr2->x_param_fsm_scale_path_stmts)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_fully_pipelined_fma != ptr2->x_param_fully_pipelined_fma)
  ...
  if (ptr1->x_param_gimple_fe_computed_hot_bb_threshold != ptr2->x_param_gimple_fe_computed_hot_bb_threshold)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_gpr2vr_cost != ptr2->x_gpr2vr_cost)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_lra_max_pseudos_points_log2_considered_for_preferences != ptr2->x_lra_max_pseudos_points_log2_considered_for_preferences)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_max_locality_partition_size != ptr2->x_param_max_locality_partition_size)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_param_max_vartrack_size != ptr2->x_param_max_vartrack_size)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_memcpy_size_threshold != ptr2->x_riscv_memcpy_size_threshold)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_memmove_size_threshold != ptr2->x_riscv_memmove_size_threshold)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_memset_size_threshold != ptr2->x_riscv_memset_size_threshold)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_memtag_instrument_allocas != ptr2->x_param_memtag_instrument_allocas)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_memtag_instrument_mem_intrinsics != ptr2->x_param_memtag_instrument_mem_intrinsics)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_min_crossjump_insns != ptr2->x_param_min_crossjump_insns)
  ...
  if (ptr1->x_riscv_autovec_mode != ptr2->x_riscv_autovec_mode
      && (!ptr1->x_riscv_autovec_mode || !ptr2->x_riscv_autovec_mode
          || strcmp (ptr1->x_riscv_autovec_mode, ptr2->x_riscv_autovec_mode)))
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_strcmp_inline_limit != ptr2->x_riscv_strcmp_inline_limit)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_two_source_permutes != ptr2->x_riscv_two_source_permutes)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_rpo_vn_max_loop_depth != ptr2->x_param_rpo_vn_max_loop_depth)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_sccvn_max_alias_queries_per_access != ptr2->x_param_sccvn_max_alias_queries_per_access)
  ...
  if (ptr1->x_param_vect_allow_possibly_not_worthwhile_vectorizations != ptr2->x_param_vect_allow_possibly_not_worthwhile_vectorizations)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_vr2fpr_cost != ptr2->x_vr2fpr_cost)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_vr2gpr_cost != ptr2->x_vr2gpr_cost)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_vrp_block_limit != ptr2->x_param_vrp_block_limit)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_param_vrp_cstload_limit != ptr2->x_param_vrp_cstload_limit)
  ...
  if (ptr1->x_param_vrp_vector_threshold != ptr2->x_param_vrp_vector_threshold)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_vsetvl_strategy != ptr2->x_vsetvl_strategy)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_dump_callgraph != ptr2->x_flag_dump_callgraph)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_copyext != ptr2->x_cobol_copyext)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_lto_dump_demangle != ptr2->x_flag_lto_dump_demangle)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_dialect != ptr2->x_cobol_dialect)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_pie != ptr2->x_flag_pie)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_a68_dump_ast != ptr2->x_flag_a68_dump_ast)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_a68_dump_modes != ptr2->x_flag_a68_dump_modes)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_a68_dump_moif != ptr2->x_flag_a68_dump_moif)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_analyzer != ptr2->x_flag_analyzer)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_analyzer_assume_nothrow != ptr2->x_flag_analyzer_assume_nothrow)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_analyzer_show_events_in_system_headers != ptr2->x_flag_analyzer_show_events_in_system_headers)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_analyzer_simplify_supergraph != ptr2->x_flag_analyzer_simplify_supergraph)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_bounds_check != ptr2->x_flag_bounds_check)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_brackets != ptr2->x_flag_brackets)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_branch_on_count_reg != ptr2->x_flag_branch_on_count_reg)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_branch_probabilities != ptr2->x_flag_branch_probabilities)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_building_libga68 != ptr2->x_flag_building_libga68)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_coarray != ptr2->x_flag_coarray)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_exceptions != ptr2->x_cobol_exceptions)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_code_hoisting != ptr2->x_flag_code_hoisting)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_combine_stack_adjustments != ptr2->x_flag_combine_stack_adjustments)
  ...
  if (ptr1->x_constexpr_ops_limit != ptr2->x_constexpr_ops_limit)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contract_checks_outlined != ptr2->x_flag_contract_checks_outlined)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contract_disable_optimized_checks != ptr2->x_flag_contract_disable_optimized_checks)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contract_evaluation_semantic != ptr2->x_flag_contract_evaluation_semantic)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contracts != ptr2->x_flag_contracts)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contract_client_check != ptr2->x_flag_contract_client_check)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contracts_conservative_ipa != ptr2->x_flag_contracts_conservative_ipa)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_contracts_definition_check != ptr2->x_flag_contracts_definition_check)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_default_real_8 != ptr2->x_flag_default_real_8)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_default_byte != ptr2->x_cobol_default_byte)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_defer_pop != ptr2->x_flag_defer_pop)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_delayed_branch != ptr2->x_flag_delayed_branch)
  ...
  if (ptr1->x_flag_diagnostics_show_caret != ptr2->x_flag_diagnostics_show_caret)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_show_context != ptr2->x_flag_diagnostics_show_context)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_diagnostics_show_line_numbers != ptr2->x_flag_diagnostics_show_line_numbers)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_show_nesting != ptr2->x_flag_diagnostics_show_nesting)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_show_nesting_levels != ptr2->x_flag_diagnostics_show_nesting_levels)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_diagnostics_show_nesting_locations != ptr2->x_flag_diagnostics_show_nesting_locations)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_excess_precision != ptr2->x_flag_excess_precision)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_charset != ptr2->x_cobol_charset)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_national_charset != ptr2->x_cobol_national_charset)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_expensive_optimizations != ptr2->x_flag_expensive_optimizations)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_ext_dce != ptr2->x_flag_ext_dce)
  ...
  if (ptr1->x_flag_external_blas != ptr2->x_flag_external_blas)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_external_blas64 != ptr2->x_flag_external_blas64)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_fixed_line_length != ptr2->x_flag_fixed_line_length)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_yy_flex_debug != ptr2->x_yy_flex_debug)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_float_store != ptr2->x_flag_float_store)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_fold_mem_offsets != ptr2->x_flag_fold_mem_offsets)
  ...
  if (ptr1->x_flag_function_sections != ptr2->x_flag_function_sections)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_fuse_ops_with_volatile_access != ptr2->x_flag_fuse_ops_with_volatile_access)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_gcse != ptr2->x_flag_gcse)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_gcse_after_reload != ptr2->x_flag_gcse_after_reload)
  ...
  if (ptr1->x_flag_implicit_templates != ptr2->x_flag_implicit_templates)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_indicator_column != ptr2->x_indicator_column)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_indirect_inlining != ptr2->x_flag_indirect_inlining)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_limit_function_alignment != ptr2->x_flag_limit_function_alignment)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_link_libatomic != ptr2->x_flag_link_libatomic)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_lto_report_wpa != ptr2->x_flag_lto_report_wpa)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_toplevel_asm_heuristics != ptr2->x_flag_toplevel_asm_heuristics)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_patchable_function_entry != ptr2->x_flag_patchable_function_entry
      && (!ptr1->x_flag_patchable_function_entry || !ptr2->x_flag_patchable_function_entry
          || strcmp (ptr1->x_flag_patchable_function_entry, ptr2->x_flag_patchable_function_entry)))
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_path_coverage_flag != ptr2->x_path_coverage_flag)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_path_coverage_limit != ptr2->x_path_coverage_limit)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_pcc_struct_return != ptr2->x_flag_pcc_struct_return)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_peel_loops != ptr2->x_flag_peel_loops)
  ...
  if (ptr1->x_flag_ree != ptr2->x_flag_ree)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_reflection != ptr2->x_flag_reflection)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_rename_registers != ptr2->x_flag_rename_registers)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_reorder_blocks != ptr2->x_flag_reorder_blocks)
  ...
  if (ptr1->x_flag_rtti != ptr2->x_flag_rtti)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_assume_builtin_offset_of != ptr2->x_flag_assume_builtin_offset_of)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_name_resolution_2_0 != ptr2->x_flag_name_resolution_2_0)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_overflow_checks != ptr2->x_flag_overflow_checks)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_rust_panic != ptr2->x_flag_rust_panic)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_unused_check_2_0 != ptr2->x_flag_unused_check_2_0)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_stack_usage != ptr2->x_flag_stack_usage)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_static_call != ptr2->x_cobol_static_call)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_strong_eval_order != ptr2->x_flag_strong_eval_order)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_stropping_regime != ptr2->x_flag_stropping_regime)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_toplevel_reorder != ptr2->x_flag_toplevel_reorder)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_trace_debug != ptr2->x_cobol_trace_debug)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_flag_tracer != ptr2->x_flag_tracer)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_flag_wrapv_pointer != ptr2->x_flag_wrapv_pointer)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_yy_debug != ptr2->x_yy_debug)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_riscv_abi != ptr2->x_riscv_abi)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_ADJUST_LMUL_COST != ptr2->x_TARGET_ADJUST_LMUL_COST)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_main_string != ptr2->x_cobol_main_string)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_align_data_type != ptr2->x_riscv_align_data_type)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_ANDI != ptr2->x_TARGET_ANDI)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_arch_string != ptr2->x_riscv_arch_string
      && (!ptr1->x_riscv_arch_string || !ptr2->x_riscv_arch_string
          || strcmp (ptr1->x_riscv_arch_string, ptr2->x_riscv_arch_string)))
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_AUIPC != ptr2->x_TARGET_AUIPC)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_mautovec_segment != ptr2->x_riscv_mautovec_segment)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_BGE != ptr2->x_TARGET_BGE)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_BGEU != ptr2->x_TARGET_BGEU)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_BLT != ptr2->x_TARGET_BLT)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_BLTU != ptr2->x_TARGET_BLTU)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_BNE != ptr2->x_TARGET_BNE)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_branch_cost != ptr2->x_riscv_branch_cost)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_BYTE != ptr2->x_TARGET_BYTE)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_cmodel != ptr2->x_riscv_cmodel)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_cpu_string != ptr2->x_riscv_cpu_string
      && (!ptr1->x_riscv_cpu_string || !ptr2->x_riscv_cpu_string
          || strcmp (ptr1->x_riscv_cpu_string, ptr2->x_riscv_cpu_string)))
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_mcsr_check != ptr2->x_riscv_mcsr_check)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_FENCE != ptr2->x_TARGET_FENCE)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_FENCE_TSO != ptr2->x_TARGET_FENCE_TSO)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_HALF != ptr2->x_TARGET_HALF)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_INLINE_SUBWORD_ATOMIC != ptr2->x_TARGET_INLINE_SUBWORD_ATOMIC)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_inline_strcmp != ptr2->x_riscv_inline_strcmp)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_inline_strlen != ptr2->x_riscv_inline_strlen)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_inline_strncmp != ptr2->x_riscv_inline_strncmp)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_isa_spec != ptr2->x_riscv_isa_spec)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_LUI != ptr2->x_TARGET_LUI)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_max_vectorization != ptr2->x_riscv_max_vectorization)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_MOVCC != ptr2->x_TARGET_MOVCC)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_arcv_mpy_option != ptr2->x_arcv_mpy_option)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_ORI != ptr2->x_TARGET_ORI)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_riscv_emit_attribute_p != ptr2->x_riscv_emit_attribute_p)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_rvv_max_lmul != ptr2->x_rvv_max_lmul)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_rvv_vector_bits != ptr2->x_rvv_vector_bits)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_SHIFT != ptr2->x_TARGET_SHIFT)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_mshorten_memrefs != ptr2->x_riscv_mshorten_memrefs)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_SLT != ptr2->x_TARGET_SLT)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_SLTI != ptr2->x_TARGET_SLTI)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_riscv_stack_protector_guard != ptr2->x_riscv_stack_protector_guard)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_stringop_strategy != ptr2->x_stringop_strategy)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_tls_dialect != ptr2->x_riscv_tls_dialect)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_riscv_tune_string != ptr2->x_riscv_tune_string
  ...
  if (ptr1->x_rvv_vector_strict_align != ptr2->x_rvv_vector_strict_align)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_TARGET_XOR != ptr2->x_TARGET_XOR)
    internal_error ("%<global_options%> are modified in local context");
  ...
  if (ptr1->x_use_pipes != ptr2->x_use_pipes)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_cobol_preprocess != ptr2->x_cobol_preprocess)
    internal_error ("%<global_options%> are modified in local context");
  if (ptr1->x_print_autofdo_gcov_version != ptr2->x_print_autofdo_gcov_version)
    internal_error ("%<global_options%> are modified in local context");
