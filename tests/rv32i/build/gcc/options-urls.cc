  ...
  switch (option_index)
    {
     ...
     case OPT__compile_std_module:
       return "gcc/C_002b_002b-Dialect-Options.html#index-compile-std-module";
     case OPT__completion_:
       break;
     case OPT__embed_dir_:
       return "gcc/Directory-Options.html#index-embed-dir";
     case OPT__help:
       return "gcc/Overall-Options.html#index-help";
     case OPT__help_:
       return "gcc/Overall-Options.html#index-help";
     case OPT__no_sysroot_suffix:
       return "gcc/Directory-Options.html#index-no-sysroot-suffix";
     ...
     case OPT__param_asan_use_after_return_:
       break;
     case OPT__param_auto_profile_bbs_:
       break;
     case OPT__param_auto_profile_reorder_only_:
       break;
     ...
     case OPT__param_ipa_cp_single_call_penalty_:
       break;
     case OPT__param_ipa_cp_sweeps_:
       break;
     ...
     case OPT__param_lra_max_considered_reload_pseudos_:
       break;
     case OPT__param_lra_max_pseudos_points_log2_considered_for_preferences_:
       break;
     case OPT__param_lto_max_locality_partition_:
       break;
     ...
     case OPT__param_lto_min_partition_:
       break;
     case OPT__param_lto_partition_locality_cloning_:
       break;
     case OPT__param_lto_partition_locality_frequency_cutoff_:
       break;
     case OPT__param_lto_partition_locality_heuristics_:
       break;
     case OPT__param_lto_partition_locality_size_cutoff_:
       break;
     ...
     case OPT__param_max_combine_insns_:
       break;
     case OPT__param_max_combine_search_insns_:
       break;
     ...
     case OPT__param_max_delay_slot_live_search_:
       break;
     case OPT__param_max_devirt_targets_:
       break;
     ...
     case OPT__param_max_modulo_backtrack_attempts_:
       break;
     case OPT__param_max_niter_dominators_walk_:
       break;
     ...
     case OPT__param_max_vartrack_size_:
       break;
     case OPT__param_memcpy_size_threshold_:
       break;
     case OPT__param_memmove_size_threshold_:
       break;
     case OPT__param_memset_size_threshold_:
       break;
     case OPT__param_memtag_instrument_allocas_:
       break;
     case OPT__param_memtag_instrument_mem_intrinsics_:
       break;
     ...
     case OPT__param_relation_block_limit_:
       break;
     case OPT__param_riscv_autovec_mode_:
       break;
     case OPT__param_riscv_strcmp_inline_limit_:
       break;
     case OPT__param_riscv_two_source_permutes:
       break;
     ...
     case OPT__param_uninit_max_num_chains_:
       break;
     case OPT__param_uninit_max_prune_work_:
       break;
     ...
     case OPT__param_vect_partial_vector_usage_:
       break;
     case OPT__param_vect_allow_possibly_not_worthwhile_vectorizations_:
       break;
     case OPT__param_vr2fpr_cost_:
       break;
     case OPT__param_vr2gpr_cost_:
       break;
     case OPT__param_vrp_block_limit_:
       break;
     case OPT__param_vrp_cstload_limit_:
       break;
     ...
     case OPT__param_vrp_vector_threshold_:
       break;
     case OPT__param_vsetvl_strategy_:
       break;
     case OPT__sysroot_:
       return "gcc/Directory-Options.html#index-sysroot";
     case OPT__target_help:
       return "gcc/Overall-Options.html#index-target-help";
     case OPT__version:
     ...
     case OPT_Hf:
       ...
       break;
     case OPT_I:
       if (lang_mask & CL_Algol68)
         return "ga68/Directory-options.html#index-I";
       if (lang_mask & CL_D)
     ...
     case OPT_L:
       if (lang_mask & CL_Algol68)
         return "ga68/Directory-options.html#index-L";
       if (lang_mask & CL_D)
     ...
     case OPT_N:
       return "gcc/Link-Options.html#index-N";
     case OPT_O:
     ...
     case OPT_Q:
       break;
     case OPT_Qn:
       return "gcc/Code-Gen-Options.html#index-Qn";
     case OPT_Qy:
       return "gcc/Code-Gen-Options.html#index-Qy";
     case OPT_R:
       break;
     case OPT_S:
       break;
     ...
     case OPT_Tbss:
       return "gcc/Link-Options.html#index-Tbss";
     case OPT_Tbss_:
       return "gcc/Link-Options.html#index-Tbss";
     case OPT_Tdata:
       return "gcc/Link-Options.html#index-Tdata";
     case OPT_Tdata_:
       return "gcc/Link-Options.html#index-Tdata";
     case OPT_Ttext:
       return "gcc/Link-Options.html#index-Ttext";
     case OPT_Ttext_:
       return "gcc/Link-Options.html#index-Ttext";
     case OPT_U:
     ...
     case OPT_Wa_:
       break;
     case OPT_Wabbreviated_auto_in_template_arg:
       return "gcc/C_002b_002b-Dialect-Options.html#index-Wabbreviated-auto-in-template-arg";
     case OPT_Wabi:
     ...
     case OPT_Wanalyzer_div_by_zero:
       return "gcc/Static-Analyzer-Options.html#index-Wanalyzer-div-by-zero";
     ...
     case OPT_Wanalyzer_mkostemp_redundant_flags:
       return "gcc/Static-Analyzer-Options.html#index-Wanalyzer-mkostemp-redundant-flags";
     case OPT_Wanalyzer_mktemp_missing_placeholder:
       return "gcc/Static-Analyzer-Options.html#index-Wanalyzer-mktemp-missing-placeholder";
     case OPT_Wanalyzer_mktemp_of_string_literal:
       return "gcc/Static-Analyzer-Options.html#index-Wanalyzer-mktemp-of-string-literal";
     ...
     case OPT_Wanalyzer_throw_of_unexpected_type:
       return "gcc/Static-Analyzer-Options.html#index-Wanalyzer-throw-of-unexpected-type";
     ...
     case OPT_Wattributes_:
       return "gcc/Warning-Options.html#index-Wattributes";
     case OPT_Wauto_profile:
       return "gcc/Warning-Options.html#index-Wauto-profile";
     ...
     case OPT_Wc__26_compat:
       return "gcc/Warning-Options.html#index-Wc_002b_002b26-compat";
     ...
     case OPT_Wcannot_profile:
       return "gcc/Warning-Options.html#index-Wcannot-profile";
     case OPT_Wcase_enum:
       break;
     ...
     case OPT_Wcoverage_too_many_paths:
       return "gcc/Warning-Options.html#index-Wcoverage-too-many-paths";
     case OPT_Wcpp:
     ...
     case OPT_Wdeprecated_copy_dtor:
       return "gcc/C_002b_002b-Dialect-Options.html#index-Wdeprecated-copy-dtor";
     ...
     case OPT_Wdeprecated_openmp:
       if (lang_mask & CL_Fortran)
         return "gfortran/Error-and-Warning-Options.html#index-Wdeprecated-openmp";
       return "gcc/Warning-Options.html#index-Wdeprecated-openmp";
     ...
     case OPT_Wexpose_global_module_tu_local:
       return "gcc/C_002b_002b-Dialect-Options.html#index-Wexpose-global-module-tu-local";
     case OPT_Wextensions:
       if (lang_mask & CL_Algol68)
         return "ga68/Warnings-options.html#index-Wextensions";
       break;
     case OPT_Wexternal_argument_mismatch:
       if (lang_mask & CL_Fortran)
         return "gfortran/Error-and-Warning-Options.html#index-Wexternal-argument-mismatch";
       break;
     case OPT_Wexternal_tu_local:
       return "gcc/C_002b_002b-Dialect-Options.html#index-Wexternal-tu-local";
     case OPT_Wextra:
       if (lang_mask & CL_D)
     ...
     case OPT_Wformat_diag:
       return "gcc/Warning-Options.html#index-Wformat-diag";
     ...
     case OPT_Whidden_declarations_:
       if (lang_mask & CL_Algol68)
         return "ga68/Warnings-options.html#index-Whidden-declarations";
       break;
     ...
     case OPT_Wkeyword_macro:
       return "gcc/Warning-Options.html#index-Wkeyword-macro";
     case OPT_Wl_:
       break;
     ...
     case OPT_Wmaybe_musttail_local_addr:
       return "gcc/Warning-Options.html#index-Wmaybe-musttail-local-addr";
     ...
     case OPT_Wmultiple_parameter_fwd_decl_lists:
       return "gcc/Warning-Options.html#index-Wmultiple-parameter-fwd-decl-lists";
     case OPT_Wmultistatement_macros:
       return "gcc/Warning-Options.html#index-Wmultistatement-macros";
     case OPT_Wmusttail_local_addr:
       return "gcc/Warning-Options.html#index-Wmusttail-local-addr";
     ...
     case OPT_Wnon_c_typedef_for_linkage:
       return "gcc/C_002b_002b-Dialect-Options.html#index-Wno-non-c-typedef-for-linkage";
     ...
     case OPT_Wobjc_root_class:
       return "gcc/Objective-C-and-Objective-C_002b_002b-Dialect-Options.html#index-Wno-objc-root-class";
     case OPT_Wodr:
     ...
     case OPT_Wpsabi:
       return "gcc/Warning-Options.html#index-Wno-psabi";
     ...
     case OPT_Wscope:
       if (lang_mask & CL_Algol68)
         return "ga68/Warnings-options.html#index-Wno-scope";
       break;
     case OPT_Wsegment:
       break;
     ...
     case OPT_Wset_to_locale:
       break;
     case OPT_Wsfinae_incomplete_:
       return "gcc/C_002b_002b-Dialect-Options.html#index-Wno-sfinae-incomplete";
     case OPT_Wshadow:
     ...
     case OPT_Wshadow_compatible_local:
       return "gcc/Warning-Options.html#index-Wno-shadow_003dcompatible-local";
     case OPT_Wshadow_local:
       return "gcc/Warning-Options.html#index-Wno-shadow_003dlocal";
     ...
     case OPT_Wtrigraphs:
       return "gcc/Warning-Options.html#index-Wno-trigraphs";
     ...
     case OPT_Wunused_macros:
       return "gcc/Warning-Options.html#index-Wno-unused-macros";
     ...
     case OPT_Wvoiding:
       if (lang_mask & CL_Algol68)
         return "ga68/Warnings-options.html#index-Wno-voiding";
       break;
     case OPT_Wvolatile:
     ...
     case OPT_Wzero_as_null_pointer_constant:
       return "gcc/Warning-Options.html#index-Wno-zero-as-null-pointer-constant";
     case OPT_Wzero_length_bounds:
       return "gcc/Warning-Options.html#index-Wno-zero-length-bounds";
     case OPT_Wzerotrip:
       if (lang_mask & CL_Fortran)
     ...
     case OPT_export_dynamic:
       break;
     case OPT_fPIC:
       return "gcc/Code-Gen-Options.html#index-fno-PIC";
     case OPT_fPIE:
       return "gcc/Code-Gen-Options.html#index-fno-PIE";
     case OPT_fRTS_:
       break;
     case OPT_fa68_dump_ast:
       if (lang_mask & CL_Algol68)
         return "ga68/Developer-options.html#index-fa68-dump-ast";
       break;
     case OPT_fa68_dump_modes:
       if (lang_mask & CL_Algol68)
         return "ga68/Developer-options.html#index-fa68-dump-modes";
       break;
     case OPT_fa68_dump_module_interfaces:
       if (lang_mask & CL_Algol68)
         return "ga68/Developer-options.html#index-fa68-dump-module-interfaces";
       break;
     ...
     case OPT_fanalyzer_assume_nothrow:
       return "gcc/Static-Analyzer-Options.html#index-fanalyzer-assume-nothrow";
     ...
     case OPT_fanalyzer_simplify_supergraph:
       return "gcc/Static-Analyzer-Options.html#index-fanalyzer-simplify-supergraph";
     ...
     case OPT_fanalyzer_verbose_edges:
       return "gcc/Static-Analyzer-Options.html#index-fanalyzer-verbose-edges";
     case OPT_fanalyzer_verbose_state_changes:
       return "gcc/Static-Analyzer-Options.html#index-fanalyzer-verbose-state-changes";
     case OPT_fanalyzer_verbosity_:
       return "gcc/Static-Analyzer-Options.html#index-fanalyzer-verbosity";
     ...
     case OPT_fassert:
       if (lang_mask & CL_Algol68)
         return "ga68/Runtime-options.html#index-fassert";
       if (lang_mask & CL_D)
     ...
     case OPT_fauto_profile_inlining:
       return "gcc/Optimize-Options.html#index-fauto-profile-inlining";
     ...
     case OPT_fbrackets:
       if (lang_mask & CL_Algol68)
         return "ga68/Dialect-options.html#index-fbrackets";
       break;
     ...
     case OPT_fc_prototypes:
       if (lang_mask & CL_Fortran)
         return "gfortran/Interoperability-Options.html#index-fc-prototypes";
       break;
     case OPT_fc_prototypes_external:
       if (lang_mask & CL_Fortran)
         return "gfortran/Interoperability-Options.html#index-fc-prototypes-external";
       break;
     ...
     case OPT_fcanonical_system_headers:
       return "gcc/Preprocessor-Options.html#index-fcanonical-system-headers";
     case OPT_fcase:
       break;
     ...
     case OPT_fcheck_:
       if (lang_mask & CL_Algol68)
         return "ga68/Runtime-options.html#index-fcheck";
       if (lang_mask & CL_Fortran)
     ...
     case OPT_fconcepts_diagnostics_depth_:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fconcepts-diagnostics-depth";
     ...
     case OPT_fcontract_checks_outlined:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fcontract-checks-outlined";
     case OPT_fcontract_disable_optimized_checks:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fcontract-disable-optimized-checks";
     case OPT_fcontract_evaluation_semantic_:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fcontract-evaluation-semantic";
     case OPT_fcontracts:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fcontracts";
     case OPT_fcontracts_client_check_:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fcontracts-client-check";
     case OPT_fcontracts_conservative_ipa:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fcontracts-conservative-ipa";
     case OPT_fcontracts_definition_check_:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fcontracts-definition-check";
     case OPT_fconvert_:
       break;
     ...
     case OPT_fcx_method_:
       return "gcc/Optimize-Options.html#index-fcx-method";
     case OPT_fd:
       break;
     ...
     case OPT_fdep_fusion:
       return "gcc/Optimize-Options.html#index-fdep-fusion";
     ...
     case OPT_fdiagnostics_plain_output:
       return "gcc/Diagnostic-Message-Formatting-Options.html#index-fdiagnostics-plain-output";
     ...
     case OPT_fdiagnostics_show_context_:
       return "gcc/Diagnostic-Message-Formatting-Options.html#index-fdiagnostics-show-context";
     ...
     case OPT_fdiagnostics_show_nesting:
       return "gcc/Diagnostic-Message-Formatting-Options.html#index-fdiagnostics-show-nesting";
     case OPT_fdiagnostics_show_nesting_levels:
       return "gcc/Diagnostic-Message-Formatting-Options.html#index-fdiagnostics-show-nesting-levels";
     case OPT_fdiagnostics_show_nesting_locations:
       return "gcc/Diagnostic-Message-Formatting-Options.html#index-fdiagnostics-show-nesting-locations";
     ...
     case OPT_fdump_ada_spec_slim:
       return "gcc/Overall-Options.html#index-fdump-ada-spec-slim";
     ...
     case OPT_fdump_analyzer_exploded_nodes:
       return "gcc/Static-Analyzer-Options.html#index-fdump-analyzer-exploded-nodes";
     case OPT_fdump_analyzer_exploded_nodes_2:
       return "gcc/Static-Analyzer-Options.html#index-fdump-analyzer-exploded-nodes-2";
     case OPT_fdump_analyzer_exploded_nodes_3:
       return "gcc/Static-Analyzer-Options.html#index-fdump-analyzer-exploded-nodes-3";
     ...
     case OPT_fdump_analyzer_feasibility:
       return "gcc/Static-Analyzer-Options.html#index-fdump-analyzer-feasibility";
     case OPT_fdump_analyzer_infinite_loop:
       return "gcc/Static-Analyzer-Options.html#index-fdump-analyzer-infinite-loop";
     ...
     case OPT_fdump_internal_locations:
       return "gcc/Developer-Options.html#index-fdump-internal-locations";
     ...
     case OPT_fext_dce:
       return "gcc/Optimize-Options.html#index-fext-dce";
     ...
     case OPT_fexternal_blas:
       ...
       break;
     case OPT_fexternal_blas64:
       if (lang_mask & CL_Fortran)
         return "gfortran/Code-Gen-Options.html#index-fexternal-blas64";
       break;
     ...
     case OPT_ffuse_ops_with_volatile_access:
       return "gcc/Optimize-Options.html#index-ffuse-ops-with-volatile-access";
     case OPT_fgcse:
     ...
     case OPT_finclude_imports:
       if (lang_mask & CL_D)
         return "gdc/Runtime-Options.html#index-finclude-imports";
       break;
     case OPT_findex:
       break;
     ...
     case OPT_finline_atomics:
       return "gcc/Optimize-Options.html#index-finline-atomics";
     ...
     case OPT_fipa_icf_functions:
       return "gcc/Optimize-Options.html#index-fipa-icf-functions";
     case OPT_fipa_icf_variables:
       return "gcc/Optimize-Options.html#index-fipa-icf-variables";
     ...
     case OPT_fipa_reorder_for_locality:
       return "gcc/Optimize-Options.html#index-fipa-reorder-for-locality";
     case OPT_fipa_sra:
     ...
     case OPT_flimit_function_alignment:
       return "gcc/Optimize-Options.html#index-flimit-function-alignment";
     case OPT_flink_libatomic:
       return "gcc/Link-Options.html#index-flink-libatomic";
     ...
     case OPT_flto_incremental_cache_size_:
       return "gcc/Optimize-Options.html#index-flto-incremental-cache-size";
     case OPT_flto_incremental_:
       return "gcc/Optimize-Options.html#index-flto-incremental";
     ...
     case OPT_flto_toplevel_asm_heuristics:
       return "gcc/Optimize-Options.html#index-flto-toplevel-asm-heuristics";
     case OPT_flto_:
       return "gcc/Optimize-Options.html#index-flto";
     case OPT_fltrans:
       break;
     ...
     case OPT_fmodules_map:
       if (lang_mask & CL_Algol68)
         return "ga68/Module-search-options.html#index-fmodules-map";
       break;
     case OPT_fmodules_map_file:
       if (lang_mask & CL_Algol68)
         return "ga68/Module-search-options.html#index-fmodules-map-file";
       break;
     ...
     case OPT_fnon_call_exceptions:
       return "gcc/Code-Gen-Options.html#index-fno-non-call-exceptions";
     ...
     case OPT_fnothrow_opt:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-nothrow-opt";
     ...
     case OPT_fobjc_call_cxx_cdtors:
       return "gcc/Objective-C-and-Objective-C_002b_002b-Dialect-Options.html#index-fno-objc-call-cxx-cdtors";
     case OPT_fobjc_direct_dispatch:
       return "gcc/Objective-C-and-Objective-C_002b_002b-Dialect-Options.html#index-fno-objc-direct-dispatch";
     case OPT_fobjc_exceptions:
       return "gcc/Objective-C-and-Objective-C_002b_002b-Dialect-Options.html#index-fno-objc-exceptions";
     case OPT_fobjc_gc:
       return "gcc/Objective-C-and-Objective-C_002b_002b-Dialect-Options.html#index-fno-objc-gc";
     case OPT_fobjc_nilcheck:
       return "gcc/Objective-C-and-Objective-C_002b_002b-Dialect-Options.html#index-fno-objc-nilcheck";
     ...
     case OPT_fomit_frame_pointer:
       return "gcc/Optimize-Options.html#index-fno-omit-frame-pointer";
     case OPT_fonly_:
       if (lang_mask & CL_D)
     ...
     case OPT_fopenacc:
       ...
       return "gcc/OpenMP-and-OpenACC-Options.html#index-fno-openacc";
     ...
     case OPT_fopenmp:
       ...
       return "gcc/OpenMP-and-OpenACC-Options.html#index-fno-openmp";
     ...
     case OPT_fopenmp_simd:
       ...
       return "gcc/OpenMP-and-OpenACC-Options.html#index-fno-openmp-simd";
     case OPT_fopenmp_target_simd_clone_:
       return "gcc/OpenMP-and-OpenACC-Options.html#index-fno-openmp-target-simd-clone";
     case OPT_foperator_names:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-operator-names";
     case OPT_fopt_info:
       return "gcc/Developer-Options.html#index-fno-opt-info";
     case OPT_fopt_info_:
       break;
     case OPT_foptimize_crc:
       return "gcc/Optimize-Options.html#index-fno-optimize-crc";
     case OPT_foptimize_sibling_calls:
       return "gcc/Optimize-Options.html#index-fno-optimize-sibling-calls";
     case OPT_foptimize_strlen:
       return "gcc/Optimize-Options.html#index-fno-optimize-strlen";
     case OPT_fpack_derived:
       if (lang_mask & CL_Fortran)
         return "gfortran/Code-Gen-Options.html#index-fpack-derived";
       break;
     case OPT_fpack_struct:
       return "gcc/Code-Gen-Options.html#index-fno-pack-struct";
     ...
     case OPT_fpartial_inlining:
       return "gcc/Optimize-Options.html#index-fno-partial-inlining";
     case OPT_fpatchable_function_entry_:
       return "gcc/Instrumentation-Options.html#index-fpatchable-function-entry";
     case OPT_fpath_coverage:
       return "gcc/Instrumentation-Options.html#index-fno-path-coverage";
     case OPT_fpath_coverage_limit_:
       return "gcc/Instrumentation-Options.html#index-fpath-coverage-limit";
     case OPT_fpcc_struct_return:
       break;
     case OPT_fpch_deps:
       return "gcc/Preprocessor-Options.html#index-fno-pch-deps";
     case OPT_fpch_preprocess:
       return "gcc/Preprocessor-Options.html#index-fno-pch-preprocess";
     case OPT_fpeel_loops:
       return "gcc/Optimize-Options.html#index-fno-peel-loops";
     case OPT_fpeephole:
       return "gcc/Optimize-Options.html#index-fno-peephole";
     case OPT_fpeephole2:
       return "gcc/Optimize-Options.html#index-fno-peephole2";
     case OPT_fpermissive:
       return "gcc/Warning-Options.html#index-fno-permissive";
     ...
     case OPT_fpost_ipa_mem_report:
       return "gcc/Developer-Options.html#index-fno-post-ipa-mem-report";
     ...
     case OPT_fpre_ipa_mem_report:
       return "gcc/Developer-Options.html#index-fno-pre-ipa-mem-report";
     case OPT_fpreconditions:
       if (lang_mask & CL_D)
         return "gdc/Runtime-Options.html#index-fno-preconditions";
       break;
     case OPT_fpredictive_commoning:
       return "gcc/Optimize-Options.html#index-fno-predictive-commoning";
     case OPT_fprefetch_loop_arrays:
       return "gcc/Optimize-Options.html#index-fno-prefetch-loop-arrays";
     case OPT_fpreprocessed:
       return "gcc/Preprocessor-Options.html#index-fno-preprocessed";
     ...
     case OPT_fprofile:
       return "gcc/Instrumentation-Options.html#index-fno-profile";
     case OPT_fprofile_abs_path:
       return "gcc/Instrumentation-Options.html#index-fno-profile-abs-path";
     case OPT_fprofile_arcs:
       break;
     case OPT_fprofile_correction:
       return "gcc/Optimize-Options.html#index-fno-profile-correction";
     ...
     case OPT_fprofile_generate:
       return "gcc/Instrumentation-Options.html#index-fno-profile-generate";
     ...
     case OPT_fprofile_partial_training:
       return "gcc/Optimize-Options.html#index-fno-profile-partial-training";
     ...
     case OPT_fprofile_reorder_functions:
       return "gcc/Optimize-Options.html#index-fno-profile-reorder-functions";
     case OPT_fprofile_report:
       return "gcc/Developer-Options.html#index-fno-profile-report";
     ...
     case OPT_fprofile_use:
       return "gcc/Optimize-Options.html#index-fno-profile-use";
     case OPT_fprofile_use_:
       return "gcc/Optimize-Options.html#index-fno-profile-use";
     case OPT_fprofile_values:
       return "gcc/Optimize-Options.html#index-fno-profile-values";
     ...
     case OPT_frandom_seed:
       return "gcc/Developer-Options.html#index-fno-random-seed";
     ...
     case OPT_frange_for_ext_temps:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-range-for-ext-temps";
     ...
     case OPT_freciprocal_math:
       return "gcc/Optimize-Options.html#index-fno-reciprocal-math";
     case OPT_frecord_gcc_switches:
       return "gcc/Code-Gen-Options.html#index-fno-record-gcc-switches";
     ...
     case OPT_frecursive:
       ...
       break;
     case OPT_free:
       return "gcc/Optimize-Options.html#index-fno-ree";
     case OPT_freflection:
       return "gcc/C_002b_002b-Dialect-Options.html#index-freflection";
     case OPT_frelease:
       if (lang_mask & CL_D)
         return "gdc/Runtime-Options.html#index-fno-release";
       break;
     case OPT_frename_registers:
       return "gcc/Optimize-Options.html#index-fno-rename-registers";
     case OPT_freorder_blocks:
       return "gcc/Optimize-Options.html#index-fno-reorder-blocks";
     case OPT_freorder_blocks_algorithm_:
       return "gcc/Optimize-Options.html#index-fno-reorder-blocks-algorithm";
     case OPT_freorder_blocks_and_partition:
       return "gcc/Optimize-Options.html#index-fno-reorder-blocks-and-partition";
     case OPT_freorder_functions:
       return "gcc/Optimize-Options.html#index-fno-reorder-functions";
     case OPT_frepack_arrays:
       if (lang_mask & CL_Fortran)
         return "gfortran/Code-Gen-Options.html#index-frepack-arrays";
       break;
     case OPT_freplace_objc_classes:
       return "gcc/Objective-C-and-Objective-C_002b_002b-Dialect-Options.html#index-fno-replace-objc-classes";
     case OPT_frepo:
       break;
     case OPT_freport_bug:
       return "gcc/Developer-Options.html#index-fno-report-bug";
     case OPT_frequire_return_statement:
       break;
     case OPT_frerun_cse_after_loop:
       return "gcc/Optimize-Options.html#index-fno-rerun-cse-after-loop";
     case OPT_freschedule_modulo_scheduled_loops:
       return "gcc/Optimize-Options.html#index-fno-reschedule-modulo-scheduled-loops";
     ...
     case OPT_frounding_math:
       return "gcc/Optimize-Options.html#index-fno-rounding-math";
     case OPT_frtti:
       if (lang_mask & CL_D)
     ...
     case OPT_fruntime_modules_:
       break;
     case OPT_frust_assume_builtin_offset_of:
       break;
     ...
     case OPT_frust_name_resolution_2_0:
       break;
     case OPT_frust_overflow_checks:
       break;
     case OPT_frust_panic_:
       break;
     case OPT_frust_unused_check_2_0:
       break;
     case OPT_fsanitize_address_use_after_scope:
       return "gcc/Instrumentation-Options.html#index-fno-sanitize-address-use-after-scope";
     ...
     case OPT_fsave_optimization_record:
       return "gcc/Developer-Options.html#index-fno-save-optimization-record";
     ...
     case OPT_fsched_critical_path_heuristic:
       return "gcc/Optimize-Options.html#index-fno-sched-critical-path-heuristic";
     case OPT_fsched_dep_count_heuristic:
       return "gcc/Optimize-Options.html#index-fno-sched-dep-count-heuristic";
     case OPT_fsched_group_heuristic:
       return "gcc/Optimize-Options.html#index-fno-sched-group-heuristic";
     case OPT_fsched_interblock:
       return "gcc/Optimize-Options.html#index-fno-sched-interblock";
     case OPT_fsched_last_insn_heuristic:
       return "gcc/Optimize-Options.html#index-fno-sched-last-insn-heuristic";
     case OPT_fsched_pressure:
       return "gcc/Optimize-Options.html#index-fno-sched-pressure";
     case OPT_fsched_rank_heuristic:
       return "gcc/Optimize-Options.html#index-fno-sched-rank-heuristic";
     case OPT_fsched_spec:
       return "gcc/Optimize-Options.html#index-fno-sched-spec";
     case OPT_fsched_spec_insn_heuristic:
       return "gcc/Optimize-Options.html#index-fno-sched-spec-insn-heuristic";
     case OPT_fsched_spec_load:
       return "gcc/Optimize-Options.html#index-fno-sched-spec-load";
     case OPT_fsched_spec_load_dangerous:
       return "gcc/Optimize-Options.html#index-fno-sched-spec-load-dangerous";
     case OPT_fsched_stalled_insns:
       return "gcc/Optimize-Options.html#index-fno-sched-stalled-insns";
     case OPT_fsched_stalled_insns_dep:
       return "gcc/Optimize-Options.html#index-fno-sched-stalled-insns-dep";
     ...
     case OPT_fsched2_use_superblocks:
       return "gcc/Optimize-Options.html#index-fno-sched2-use-superblocks";
     case OPT_fschedule_fusion:
       return "gcc/Optimize-Options.html#index-fno-schedule-fusion";
     case OPT_fschedule_insns:
       return "gcc/Optimize-Options.html#index-fno-schedule-insns";
     case OPT_fschedule_insns2:
       return "gcc/Optimize-Options.html#index-fno-schedule-insns2";
     case OPT_fsearch_include_path:
       return "gcc/Preprocessor-Options.html#index-fno-search-include-path";
     ...
     case OPT_fsection_anchors:
       return "gcc/Optimize-Options.html#index-fno-section-anchors";
     case OPT_fsel_sched_pipelining:
       return "gcc/Optimize-Options.html#index-fno-sel-sched-pipelining";
     case OPT_fsel_sched_pipelining_outer_loops:
       return "gcc/Optimize-Options.html#index-fno-sel-sched-pipelining-outer-loops";
     case OPT_fsel_sched_reschedule_pipelined:
       break;
     case OPT_fselective_scheduling:
       return "gcc/Optimize-Options.html#index-fno-selective-scheduling";
     case OPT_fselective_scheduling2:
       return "gcc/Optimize-Options.html#index-fno-selective-scheduling2";
     case OPT_fself_test_:
       break;
     case OPT_fsemantic_interposition:
       return "gcc/Optimize-Options.html#index-fno-semantic-interposition";
     case OPT_fshared:
       break;
     ...
     case OPT_fshort_wchar:
       return "gcc/Code-Gen-Options.html#index-fno-short-wchar";
     case OPT_fshow_column:
       return "gcc/Diagnostic-Message-Formatting-Options.html#index-fno-show-column";
     case OPT_fshrink_wrap:
       return "gcc/Optimize-Options.html#index-fno-shrink-wrap";
     case OPT_fshrink_wrap_separate:
       return "gcc/Optimize-Options.html#index-fno-shrink-wrap-separate";
     case OPT_fsign_zero:
       if (lang_mask & CL_Fortran)
         return "gfortran/Runtime-Options.html#index-fsign-zero";
       break;
     case OPT_fsignaling_nans:
       return "gcc/Optimize-Options.html#index-fno-signaling-nans";
     ...
     case OPT_fsingle_precision_constant:
       return "gcc/Optimize-Options.html#index-fno-single-precision-constant";
     case OPT_fsized_deallocation:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-sized-deallocation";
     case OPT_fsoft_check_all:
       break;
     case OPT_fsources:
       break;
     case OPT_fspeculatively_call_stored_functions:
       return "gcc/Optimize-Options.html#index-fno-speculatively-call-stored-functions";
     case OPT_fsplit_ivs_in_unroller:
       return "gcc/Optimize-Options.html#index-fno-split-ivs-in-unroller";
     case OPT_fsplit_loops:
       return "gcc/Optimize-Options.html#index-fno-split-loops";
     case OPT_fsplit_paths:
       return "gcc/Optimize-Options.html#index-fno-split-paths";
     case OPT_fsplit_stack:
       return "gcc/Instrumentation-Options.html#index-fno-split-stack";
     case OPT_fsplit_wide_types:
       return "gcc/Optimize-Options.html#index-fno-split-wide-types";
     case OPT_fsplit_wide_types_early:
       return "gcc/Optimize-Options.html#index-fno-split-wide-types-early";
     case OPT_fsquangle:
       break;
     case OPT_fssa_backprop:
       return "gcc/Optimize-Options.html#index-fno-ssa-backprop";
     case OPT_fssa_phiopt:
       return "gcc/Optimize-Options.html#index-fno-ssa-phiopt";
     ...
     case OPT_fstack_check_:
       return "gcc/Instrumentation-Options.html#index-fno-stack-check";
     case OPT_fstack_clash_protection:
       return "gcc/Instrumentation-Options.html#index-fno-stack-clash-protection";
     ...
     case OPT_fstack_protector:
       return "gcc/Instrumentation-Options.html#index-fno-stack-protector";
     ...
     case OPT_fstack_reuse_:
       return "gcc/Code-Gen-Options.html#index-fstack-reuse";
     case OPT_fstack_usage:
       return "gcc/Developer-Options.html#index-fstack-usage";
     case OPT_fstatic_call:
       break;
     case OPT_fstats:
       return "gcc/Developer-Options.html#index-fno-stats";
     case OPT_fstdarg_opt:
       return "gcc/Optimize-Options.html#index-fno-stdarg-opt";
     case OPT_fstore_merging:
       return "gcc/Optimize-Options.html#index-fno-store-merging";
     case OPT_fstrict_aliasing:
       return "gcc/Optimize-Options.html#index-fno-strict-aliasing";
     case OPT_fstrict_enums:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-strict-enums";
     case OPT_fstrict_flex_arrays_:
       return "gcc/C-Dialect-Options.html#index-fno-strict-flex-arrays";
     case OPT_fstrict_overflow:
       return "gcc/Code-Gen-Options.html#index-fno-strict-overflow";
     case OPT_fstrict_prototype:
       break;
     case OPT_fstrict_volatile_bitfields:
       return "gcc/Code-Gen-Options.html#index-fno-strict-volatile-bitfields";
     case OPT_fstrong_eval_order_:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-strong-eval-order";
     ...
     case OPT_ftest_coverage:
       return "gcc/Instrumentation-Options.html#index-fno-test-coverage";
     ...
     case OPT_fthread_jumps:
       return "gcc/Optimize-Options.html#index-fno-thread-jumps";
     ...
     case OPT_ftime_report:
       return "gcc/Developer-Options.html#index-fno-time-report";
     case OPT_ftime_report_details:
       return "gcc/Developer-Options.html#index-fno-time-report-details";
     ...
     case OPT_ftrace_debug:
       break;
     case OPT_ftracer:
       return "gcc/Optimize-Options.html#index-fno-tracer";
     ...
     case OPT_ftrampolines:
       return "gcc/Code-Gen-Options.html#index-fno-trampolines";
     ...
     case OPT_ftrapv:
       return "gcc/Code-Gen-Options.html#index-fno-trapv";
     case OPT_ftree_bit_ccp:
       return "gcc/Optimize-Options.html#index-fno-tree-bit-ccp";
     case OPT_ftree_builtin_call_dce:
       return "gcc/Optimize-Options.html#index-fno-tree-builtin-call-dce";
     case OPT_ftree_ccp:
       return "gcc/Optimize-Options.html#index-fno-tree-ccp";
     case OPT_ftree_ch:
       return "gcc/Optimize-Options.html#index-fno-tree-ch";
     case OPT_ftree_coalesce_vars:
       return "gcc/Optimize-Options.html#index-fno-tree-coalesce-vars";
     case OPT_ftree_copy_prop:
       return "gcc/Optimize-Options.html#index-fno-tree-copy-prop";
     case OPT_ftree_cselim:
       return "gcc/Optimize-Options.html#index-fno-tree-cselim";
     case OPT_ftree_dce:
       return "gcc/Optimize-Options.html#index-fno-tree-dce";
     case OPT_ftree_dominator_opts:
       return "gcc/Optimize-Options.html#index-fno-tree-dominator-opts";
     case OPT_ftree_dse:
       return "gcc/Optimize-Options.html#index-fno-tree-dse";
     case OPT_ftree_forwprop:
       return "gcc/Optimize-Options.html#index-fno-tree-forwprop";
     case OPT_ftree_fre:
       return "gcc/Optimize-Options.html#index-fno-tree-fre";
     case OPT_ftree_loop_distribute_patterns:
       return "gcc/Optimize-Options.html#index-fno-tree-loop-distribute-patterns";
     case OPT_ftree_loop_distribution:
       return "gcc/Optimize-Options.html#index-fno-tree-loop-distribution";
     case OPT_ftree_loop_if_convert:
       return "gcc/Optimize-Options.html#index-fno-tree-loop-if-convert";
     case OPT_ftree_loop_im:
       return "gcc/Optimize-Options.html#index-fno-tree-loop-im";
     case OPT_ftree_loop_ivcanon:
       return "gcc/Optimize-Options.html#index-fno-tree-loop-ivcanon";
     case OPT_ftree_loop_optimize:
       return "gcc/Optimize-Options.html#index-fno-tree-loop-optimize";
     case OPT_ftree_loop_vectorize:
       return "gcc/Optimize-Options.html#index-fno-tree-loop-vectorize";
     case OPT_ftree_parallelize_loops_:
       return "gcc/Optimize-Options.html#index-fno-tree-parallelize-loops";
     case OPT_ftree_partial_pre:
       return "gcc/Optimize-Options.html#index-fno-tree-partial-pre";
     case OPT_ftree_phiprop:
       return "gcc/Optimize-Options.html#index-fno-tree-phiprop";
     case OPT_ftree_pre:
       return "gcc/Optimize-Options.html#index-fno-tree-pre";
     case OPT_ftree_pta:
       return "gcc/Optimize-Options.html#index-fno-tree-pta";
     case OPT_ftree_reassoc:
       return "gcc/Optimize-Options.html#index-fno-tree-reassoc";
     case OPT_ftree_scev_cprop:
       return "gcc/Optimize-Options.html#index-fno-tree-scev-cprop";
     case OPT_ftree_sink:
       return "gcc/Optimize-Options.html#index-fno-tree-sink";
     case OPT_ftree_slp_vectorize:
       return "gcc/Optimize-Options.html#index-fno-tree-slp-vectorize";
     case OPT_ftree_slsr:
       return "gcc/Optimize-Options.html#index-fno-tree-slsr";
     case OPT_ftree_sra:
       return "gcc/Optimize-Options.html#index-fno-tree-sra";
     case OPT_ftree_switch_conversion:
       return "gcc/Optimize-Options.html#index-fno-tree-switch-conversion";
     case OPT_ftree_tail_merge:
       return "gcc/Optimize-Options.html#index-fno-tree-tail-merge";
     case OPT_ftree_ter:
       return "gcc/Optimize-Options.html#index-fno-tree-ter";
     case OPT_ftree_vectorize:
       return "gcc/Optimize-Options.html#index-fno-tree-vectorize";
     case OPT_ftree_vrp:
       return "gcc/Optimize-Options.html#index-fno-tree-vrp";
     ...
     case OPT_funconstrained_commons:
       return "gcc/Optimize-Options.html#index-fno-unconstrained-commons";
     case OPT_funderscoring:
       if (lang_mask & CL_Fortran)
         return "gfortran/Code-Gen-Options.html#index-fno-underscoring";
       break;
     case OPT_funit_at_a_time:
       return "gcc/Optimize-Options.html#index-fno-unit-at-a-time";
     case OPT_funittest:
       if (lang_mask & CL_D)
         return "gdc/Runtime-Options.html#index-fno-unittest";
       break;
     case OPT_funreachable_traps:
       return "gcc/Optimize-Options.html#index-fno-unreachable-traps";
     case OPT_funroll_all_loops:
       return "gcc/Optimize-Options.html#index-fno-unroll-all-loops";
     case OPT_funroll_completely_grow_size:
       break;
     case OPT_funroll_loops:
       return "gcc/Optimize-Options.html#index-fno-unroll-loops";
     case OPT_funsafe_math_optimizations:
       return "gcc/Optimize-Options.html#index-fno-unsafe-math-optimizations";
     case OPT_funsigned:
       if (lang_mask & CL_Fortran)
     ...
     case OPT_funswitch_loops:
       return "gcc/Optimize-Options.html#index-fno-unswitch-loops";
     case OPT_funwind_tables:
       return "gcc/Code-Gen-Options.html#index-fno-unwind-tables";
     case OPT_fuse_cxa_atexit:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-use-cxa-atexit";
     case OPT_fuse_cxa_get_exception_ptr:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-use-cxa-get-exception-ptr";
     case OPT_fuse_ld_bfd:
       return "gcc/Link-Options.html#index-fno-use-ld_003dbfd";
     case OPT_fuse_ld_gold:
       return "gcc/Link-Options.html#index-fno-use-ld_003dgold";
     case OPT_fuse_ld_lld:
       return "gcc/Link-Options.html#index-fno-use-ld_003dlld";
     case OPT_fuse_ld_mold:
       return "gcc/Link-Options.html#index-fno-use-ld_003dmold";
     case OPT_fuse_ld_wild:
       return "gcc/Link-Options.html#index-fno-use-ld_003dwild";
     case OPT_fuse_linker_plugin:
       return "gcc/Optimize-Options.html#index-fuse-linker-plugin";
     case OPT_fuse_list_:
       break;
     case OPT_fvar_tracking:
       return "gcc/Debugging-Options.html#index-fno-var-tracking";
     ...
     case OPT_fvar_tracking_uninit:
       return "gcc/Debugging-Options.html#index-fno-var-tracking-uninit";
     case OPT_fvariable_expansion_in_unroller:
       return "gcc/Optimize-Options.html#index-fno-variable-expansion-in-unroller";
     case OPT_fvect_cost_model_:
       return "gcc/Optimize-Options.html#index-fno-vect-cost-model";
     case OPT_fverbose_asm:
       return "gcc/Code-Gen-Options.html#index-fno-verbose-asm";
     case OPT_fversion_loops_for_strides:
       return "gcc/Optimize-Options.html#index-fno-version-loops-for-strides";
     case OPT_fversion_:
       if (lang_mask & CL_D)
         return "gdc/Runtime-Options.html#index-fversion";
       break;
     case OPT_fvisibility_inlines_hidden:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-visibility-inlines-hidden";
     case OPT_fvisibility_ms_compat:
       return "gcc/C_002b_002b-Dialect-Options.html#index-fno-visibility-ms-compat";
     case OPT_fvisibility_:
       return "gcc/Code-Gen-Options.html#index-fvisibility";
     case OPT_fvpt:
       return "gcc/Optimize-Options.html#index-fno-vpt";
     case OPT_fvtable_gc:
       break;
     ...
     case OPT_fvtv_counts:
       return "gcc/Instrumentation-Options.html#index-fno-vtv-counts";
     case OPT_fvtv_debug:
       return "gcc/Instrumentation-Options.html#index-fno-vtv-debug";
     case OPT_fweak:
     ...
     case OPT_fweak_templates:
       ...
       break;
     case OPT_fweb:
       return "gcc/Optimize-Options.html#index-fno-web";
     case OPT_fwhole_program:
       return "gcc/Optimize-Options.html#index-fno-whole-program";
     case OPT_fwholediv:
       break;
     ...
     case OPT_fwpa_:
       break;
     case OPT_fwrapv:
       return "gcc/Code-Gen-Options.html#index-fno-wrapv";
     case OPT_fwrapv_pointer:
       return "gcc/Code-Gen-Options.html#index-fno-wrapv-pointer";
     case OPT_fxref:
       break;
     ...
     case OPT_fzero_link:
       return "gcc/Objective-C-and-Objective-C_002b_002b-Dialect-Options.html#index-fno-zero-link";
     case OPT_g:
     ...
     case OPT_gno_pubnames:
       return "gcc/Debugging-Options.html#index-gno-pubnames";
     case OPT_gprune_btf:
     ...
     case OPT_imultiarch:
       return "gcc/Directory-Options.html#index-imultiarch";
     case OPT_imultilib:
       if (lang_mask & CL_D)
     ...
     case OPT_list:
       break;
     case OPT_mabi_:
       return "gcc/RISC-V-Options.html#index-mabi-6";
     case OPT_madjust_lmul_cost:
       return "gcc/RISC-V-Options.html#index-madjust-lmul-cost";
     case OPT_main:
       break;
     case OPT_main_:
       break;
     case OPT_malign_data_:
       return "gcc/RISC-V-Options.html#index-malign-data";
     case OPT_mandi:
       break;
     case OPT_march_:
       return "gcc/RISC-V-Options.html#index-march-11";
     case OPT_march_help:
       break;
     case OPT_mauipc:
       break;
     case OPT_mautovec_segment:
       return "gcc/RISC-V-Options.html#index-mautovec-segment";
     case OPT_mbge:
       break;
     case OPT_mbgeu:
       break;
     case OPT_mbig_endian:
       return "gcc/RISC-V-Options.html#index-mbig-endian-9";
     case OPT_mblt:
       break;
     case OPT_mbltu:
       break;
     ...
     case OPT_mbranch_cost_:
       return "gcc/RISC-V-Options.html#index-mbranch-cost-5";
     case OPT_mbyte:
       break;
     case OPT_mcmodel_:
       return "gcc/RISC-V-Options.html#index-mcmodel_003d-4";
     case OPT_mcpu_:
       return "gcc/RISC-V-Options.html#index-mcpu-8";
     case OPT_mcsr_check:
       return "gcc/RISC-V-Options.html#index-mcsr-check";
     case OPT_mdiv:
       return "gcc/RISC-V-Options.html#index-mdiv-3";
     case OPT_mexplicit_relocs:
       return "gcc/RISC-V-Options.html#index-mexplicit-relocs-3";
     case OPT_mfdiv:
       return "gcc/RISC-V-Options.html#index-mfdiv";
     case OPT_mfence:
       break;
     case OPT_mfence_tso:
       return "gcc/RISC-V-Options.html#index-mfence-tso";
     case OPT_mhalf:
       break;
     case OPT_minline_atomics:
       return "gcc/RISC-V-Options.html#index-minline-atomics";
     case OPT_minline_strcmp:
       return "gcc/RISC-V-Options.html#index-minline-strcmp";
     case OPT_minline_strlen:
       return "gcc/RISC-V-Options.html#index-minline-strlen";
     case OPT_minline_strncmp:
       return "gcc/RISC-V-Options.html#index-minline-strncmp";
     case OPT_misa_spec_:
       return "gcc/RISC-V-Options.html#index-misa-spec";
     case OPT_mlittle_endian:
       return "gcc/RISC-V-Options.html#index-mlittle-endian-9";
     case OPT_mlui:
       break;
     case OPT_mmax_vectorization:
       return "gcc/RISC-V-Options.html#index-mmax-vectorization-1";
     case OPT_mmovcc:
       return "gcc/RISC-V-Options.html#index-mmovcc";
     case OPT_mmpy_option_:
       break;
     case OPT_momit_leaf_frame_pointer:
       return "gcc/RISC-V-Options.html#index-momit-leaf-frame-pointer-2";
     case OPT_mori:
       break;
     case OPT_mpreferred_stack_boundary_:
       return "gcc/RISC-V-Options.html#index-mpreferred-stack-boundary";
     case OPT_mrelax:
       return "gcc/RISC-V-Options.html#index-mrelax-6";
     case OPT_mriscv_attribute:
       return "gcc/RISC-V-Options.html#index-mriscv-attribute";
     case OPT_mrvv_max_lmul_:
       return "gcc/RISC-V-Options.html#index-mrvv-max-lmul";
     case OPT_mrvv_vector_bits_:
       return "gcc/RISC-V-Options.html#index-mrvv-vector-bits";
     case OPT_msave_restore:
       return "gcc/RISC-V-Options.html#index-msave-restore";
     case OPT_mshift:
       break;
     case OPT_mshorten_memrefs:
       return "gcc/RISC-V-Options.html#index-mshorten-memrefs";
     case OPT_mslt:
       break;
     case OPT_mslti:
       break;
     case OPT_msmall_data_limit_:
       return "gcc/RISC-V-Options.html#index-msmall-data-limit";
     case OPT_mstack_protector_guard_offset_:
       return "gcc/RISC-V-Options.html#index-mstack-protector-guard-offset-2";
     case OPT_mstack_protector_guard_reg_:
       return "gcc/RISC-V-Options.html#index-mstack-protector-guard-reg-1";
     case OPT_mstack_protector_guard_:
       return "gcc/RISC-V-Options.html#index-mstack-protector-guard-2";
     case OPT_mstrict_align:
       return "gcc/RISC-V-Options.html#index-mstrict-align-4";
     case OPT_mstringop_strategy_:
       return "gcc/RISC-V-Options.html#index-mstringop-strategy";
     case OPT_mtls_dialect_:
       break;
     case OPT_mtune_:
       return "gcc/RISC-V-Options.html#index-mtune-11";
     case OPT_mvector_strict_align:
       return "gcc/RISC-V-Options.html#index-mvector-strict-align";
     case OPT_mxor:
       break;
     case OPT_n:
       return "gcc/Link-Options.html#index-n";
     ...
     case OPT_preprocess:
       return "gcc/Overall-Options.html#index-preprocess";
     case OPT_print_autofdo_gcov_version:
       return "gcc/Developer-Options.html#index-print-autofdo-gcov-version";
     ...
     case OPT_shared_libga68:
       if (lang_mask & CL_Algol68)
         return "ga68/Linking-options.html#index-shared-libga68";
       break;
     ...
     case OPT_size_sort:
       break;
     case OPT_specs_:
       return "gcc/Developer-Options.html#index-specs";
     case OPT_static:
       return "gcc/Link-Options.html#index-static";
     case OPT_static_libasan:
       return "gcc/Link-Options.html#index-static-libasan";
     case OPT_static_libga68:
       if (lang_mask & CL_Algol68)
         return "ga68/Linking-options.html#index-static-libga68";
       break;
     ...
     case OPT_static_libhwasan:
       return "gcc/Link-Options.html#index-static-libhwasan";
