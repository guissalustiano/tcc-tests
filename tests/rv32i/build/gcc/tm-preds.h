...
extern bool prefetch_const_operand (rtx, machine_mode);
extern bool zicbop_prefetch_operand (rtx, machine_mode);
extern bool mips_prefetch_operand (rtx, machine_mode);
...
extern bool const_int5_operand (rtx, machine_mode);
...
extern bool strided_broadcast_mask_operand (rtx, machine_mode);
...
extern bool comparison_swappable_operator (rtx, machine_mode);
extern bool ge_operator (rtx, machine_mode);
extern bool riscv_cbranch_comparison_operator (rtx, machine_mode);
...
extern bool strided_broadcast_operand (rtx, machine_mode);
extern bool any_broadcast_operand (rtx, machine_mode);
...
extern bool bitpos_mask_operand (rtx, machine_mode);
extern bool reg_or_const_int_operand (rtx, machine_mode);
extern bool ads_branch_bbcs_operand (rtx, machine_mode);
extern bool ads_branch_bimm_operand (rtx, machine_mode);
extern bool ads_imm_extract_operand (rtx, machine_mode);
extern bool ads_extract_size_imm_si (rtx, machine_mode);
extern bool ads_extract_size_imm_di (rtx, machine_mode);
...
{
  if (c >= CONSTRAINT_k01 && c <= CONSTRAINT_ads__Bext)
    return;
  if (c >= CONSTRAINT_V && c <= CONSTRAINT_Wdm)
    {
      *allows_mem = true;
      return;
    }
